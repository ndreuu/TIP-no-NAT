...
(assert (forall ((x_25378 It_1) (x_25379 list_117) (x_25380 It_1) (x_25381 list_117))
	(=> (diseqIt_1 x_25378 x_25380)
	    (diseqlist_117 (cons_117 x_25378 x_25379) (cons_117 x_25380 x_25381)))))
(assert (forall ((x_25378 It_1) (x_25379 list_117) (x_25380 It_1) (x_25381 list_117))
	(=> (diseqlist_117 x_25379 x_25381)
	    (diseqlist_117 (cons_117 x_25378 x_25379) (cons_117 x_25380 x_25381)))))
...
(assert (forall ((x_25342 Bool_163) (x_25331 It_1) (x_25332 list_117) (x_25330 list_117))
	(=> (isPrefix_1 x_25342 x_25330 x_25332)
	    (isPrefix_1 x_25342 (cons_117 x_25331 x_25330) (cons_117 x_25331 x_25332)))))
(assert (forall ((x_25331 It_1) (x_25332 list_117) (z_921 It_1) (x_25330 list_117))
	(=> (diseqIt_1 z_921 x_25331)
	    (isPrefix_1 false_163 (cons_117 z_921 x_25330) (cons_117 x_25331 x_25332)))))
...
(assert (forall ((x_25347 Bool_163) (x_25337 It_1) (x_25338 list_117) (x_25335 It_1) (x_25336 list_117))
	(=> (isRelaxedPrefix_1 x_25347 (cons_117 x_25335 x_25336) x_25338)
	    (isRelaxedPrefix_1 x_25347 (cons_117 x_25337 (cons_117 x_25335 x_25336)) (cons_117 x_25337 x_25338)))))
(assert (forall ((x_25349 Bool_163) (x_25337 It_1) (x_25338 list_117) (x_25335 It_1) (x_25336 list_117) (z_922 It_1))
	(=>	(and (diseqIt_1 z_922 x_25337)
			(isPrefix_1 x_25349 (cons_117 x_25335 x_25336) (cons_117 x_25337 x_25338)))
		(isRelaxedPrefix_1 x_25349 (cons_117 z_922 (cons_117 x_25335 x_25336)) (cons_117 x_25337 x_25338)))))
...
(assert (forall ((x_25355 list_117) (z_923 It_1) (xs_296 list_117) (y_942 list_117))
	(=> (x_25339 x_25355 xs_296 y_942)
	    (x_25339 (cons_117 z_923 x_25355) (cons_117 z_923 xs_296) y_942))))
...
(assert (forall ((x_25357 list_117) (x_25358 list_117) (x_25359 list_117) (x_25360 list_117) (x_25341 It_1) (xs_297 list_117) (ys_89 list_117) (zs_23 list_117))
	(=>	(and true
			(x_25339 x_25357 (cons_117 x_25341 nil_130) ys_89)
			(x_25339 x_25358 xs_297 x_25357)
			(x_25339 x_25359 ys_89 zs_23)
			(x_25339 x_25360 xs_297 x_25359)
			(isRelaxedPrefix_1 false_163 x_25358 x_25360))
		false)))
(check-sat)
