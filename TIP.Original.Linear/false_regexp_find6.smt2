...
(assert (forall ((x_59258 T_4) (x_59259 list_297) (x_59260 T_4) (x_59261 list_297))
	(=> (diseqT_4 x_59258 x_59260)
	    (diseqlist_295 (cons_295 x_59258 x_59259) (cons_295 x_59260 x_59261)))))
(assert (forall ((x_59258 T_4) (x_59259 list_297) (x_59260 T_4) (x_59261 list_297))
	(=> (diseqlist_295 x_59259 x_59261)
	    (diseqlist_295 (cons_295 x_59258 x_59259) (cons_295 x_59260 x_59261)))))
...
(assert (forall ((x_59340 T_4) (x_59341 T_4))
	(=> (diseqT_4 x_59340 x_59341)
	    (diseqR_18 (Atom_18 x_59340) (Atom_18 x_59341)))))
(assert (forall ((x_59342 R_473) (x_59343 R_473) (x_59344 R_473) (x_59345 R_473))
	(=> (diseqR_18 x_59342 x_59344)
	    (diseqR_18 (x_59200 x_59342 x_59343) (x_59200 x_59344 x_59345)))))
(assert (forall ((x_59342 R_473) (x_59343 R_473) (x_59344 R_473) (x_59345 R_473))
	(=> (diseqR_18 x_59343 x_59345)
	    (diseqR_18 (x_59200 x_59342 x_59343) (x_59200 x_59344 x_59345)))))
(assert (forall ((x_59346 R_473) (x_59347 R_473) (x_59348 R_473) (x_59349 R_473))
	(=> (diseqR_18 x_59346 x_59348)
	    (diseqR_18 (x_59201 x_59346 x_59347) (x_59201 x_59348 x_59349)))))
(assert (forall ((x_59346 R_473) (x_59347 R_473) (x_59348 R_473) (x_59349 R_473))
	(=> (diseqR_18 x_59347 x_59349)
	    (diseqR_18 (x_59201 x_59346 x_59347) (x_59201 x_59348 x_59349)))))
(assert (forall ((x_59350 R_473) (x_59351 R_473))
	(=> (diseqR_18 x_59350 x_59351)
	    (diseqR_18 (Star_18 x_59350) (Star_18 x_59351)))))
...
(assert (forall ((x_59209 Bool_380) (x_59210 Bool_380) (x_59211 Bool_380) (r_474 R_473) (q_163 R_473))
	(=>	(and (eps_37 x_59210 r_474)
			(eps_37 x_59211 q_163)
			(and_381 x_59209 x_59210 x_59211))
		(eps_37 x_59209 (x_59201 r_474 q_163)))))
(assert (forall ((x_59212 Bool_380) (x_59213 Bool_380) (x_59214 Bool_380) (p_430 R_473) (q_164 R_473))
	(=>	(and (eps_37 x_59213 p_430)
			(eps_37 x_59214 q_164)
			(or_392 x_59212 x_59213 x_59214))
		(eps_37 x_59212 (x_59200 p_430 q_164)))))
...
(assert (forall ((x_59219 R_473) (p_431 R_473) (y_2554 T_4))
	(=> (step_18 x_59219 p_431 y_2554)
	    (step_18 (x_59201 x_59219 (Star_18 p_431)) (Star_18 p_431) y_2554))))
(assert (forall ((x_59222 R_473) (x_59223 R_473) (r_475 R_473) (q_165 R_473) (y_2554 T_4))
	(=>	(and (step_18 x_59222 r_475 y_2554)
			(step_18 x_59223 q_165 y_2554)
			(eps_37 true_380 r_475))
		(step_18 (x_59200 (x_59201 x_59222 q_165) x_59223) (x_59201 r_475 q_165) y_2554))))
(assert (forall ((x_59226 R_473) (r_475 R_473) (q_165 R_473) (y_2554 T_4))
	(=>	(and (step_18 x_59226 r_475 y_2554)
			(eps_37 false_380 r_475))
		(step_18 (x_59200 (x_59201 x_59226 q_165) Nil_330) (x_59201 r_475 q_165) y_2554))))
(assert (forall ((x_59228 R_473) (x_59229 R_473) (p_432 R_473) (q_166 R_473) (y_2554 T_4))
	(=>	(and (step_18 x_59228 p_432 y_2554)
			(step_18 x_59229 q_166 y_2554))
		(step_18 (x_59200 x_59228 x_59229) (x_59200 p_432 q_166) y_2554))))
(assert (forall ((b_53 T_4))
	(step_18 Eps_36 (Atom_18 b_53) b_53)))
(assert (forall ((b_53 T_4) (y_2554 T_4))
	(=> (diseqT_4 b_53 y_2554)
	    (step_18 Nil_330 (Atom_18 b_53) y_2554))))
...
(assert (forall ((x_59234 Bool_380) (x_59235 R_473) (z_2288 T_4) (xs_753 list_297) (x_59206 R_473))
	(=>	(and (step_18 x_59235 x_59206 z_2288)
			(rec_4 x_59234 x_59235 xs_753))
		(rec_4 x_59234 x_59206 (cons_295 z_2288 xs_753)))))
(assert (forall ((x_59237 Bool_380) (x_59206 R_473))
	(=> (eps_37 x_59237 x_59206)
	    (rec_4 x_59237 x_59206 nil_329))))
(assert (forall ((p_433 R_473))
	(=>	(and true
			(rec_4 true_380 p_433 (cons_295 A_64 (cons_295 B_52 (cons_295 A_64 (cons_295 B_52 (cons_295 B_52 nil_329)))))))
		false)))
(check-sat)
