...
(assert (forall ((x_56578 Bool_365) (x_56579 list_263) (x_56580 Bool_365) (x_56581 list_263))
	(=> (diseqBool_166 x_56578 x_56580)
	    (diseqlist_263 (cons_263 x_56578 x_56579) (cons_263 x_56580 x_56581)))))
(assert (forall ((x_56578 Bool_365) (x_56579 list_263) (x_56580 Bool_365) (x_56581 list_263))
	(=> (diseqlist_263 x_56579 x_56581)
	    (diseqlist_263 (cons_263 x_56578 x_56579) (cons_263 x_56580 x_56581)))))
...
(assert (forall ((x_56595 T_0) (x_56596 list_264) (x_56597 T_0) (x_56598 list_264))
	(=> (diseqT_0 x_56595 x_56597)
	    (diseqlist_264 (cons_264 x_56595 x_56596) (cons_264 x_56597 x_56598)))))
(assert (forall ((x_56595 T_0) (x_56596 list_264) (x_56597 T_0) (x_56598 list_264))
	(=> (diseqlist_264 x_56596 x_56598)
	    (diseqlist_264 (cons_264 x_56595 x_56596) (cons_264 x_56597 x_56598)))))
...
(assert (forall ((x_56604 list_264) (x_56605 list_264) (x_56606 list_264) (x_56607 list_264))
	(=> (diseqlist_264 x_56604 x_56606)
	    (diseqpair_47 (pair_95 x_56604 x_56605) (pair_95 x_56606 x_56607)))))
(assert (forall ((x_56604 list_264) (x_56605 list_264) (x_56606 list_264) (x_56607 list_264))
	(=> (diseqlist_264 x_56605 x_56607)
	    (diseqpair_47 (pair_95 x_56604 x_56605) (pair_95 x_56606 x_56607)))))
...
(assert (forall ((x_56618 pair_94) (x_56619 list_265) (x_56620 pair_94) (x_56621 list_265))
	(=> (diseqpair_47 x_56618 x_56620)
	    (diseqlist_265 (cons_265 x_56618 x_56619) (cons_265 x_56620 x_56621)))))
(assert (forall ((x_56618 pair_94) (x_56619 list_265) (x_56620 pair_94) (x_56621 list_265))
	(=> (diseqlist_265 x_56619 x_56621)
	    (diseqlist_265 (cons_265 x_56618 x_56619) (cons_265 x_56620 x_56621)))))
...
(assert (forall ((x_56700 T_0) (x_56701 T_0))
	(=> (diseqT_0 x_56700 x_56701)
	    (diseqR_14 (Atom_14 x_56700) (Atom_14 x_56701)))))
(assert (forall ((x_56702 R_438) (x_56703 R_438) (x_56704 R_438) (x_56705 R_438))
	(=> (diseqR_14 x_56702 x_56704)
	    (diseqR_14 (x_56473 x_56702 x_56703) (x_56473 x_56704 x_56705)))))
(assert (forall ((x_56702 R_438) (x_56703 R_438) (x_56704 R_438) (x_56705 R_438))
	(=> (diseqR_14 x_56703 x_56705)
	    (diseqR_14 (x_56473 x_56702 x_56703) (x_56473 x_56704 x_56705)))))
(assert (forall ((x_56706 R_438) (x_56707 R_438) (x_56708 R_438) (x_56709 R_438))
	(=> (diseqR_14 x_56706 x_56708)
	    (diseqR_14 (x_56474 x_56706 x_56707) (x_56474 x_56708 x_56709)))))
(assert (forall ((x_56706 R_438) (x_56707 R_438) (x_56708 R_438) (x_56709 R_438))
	(=> (diseqR_14 x_56707 x_56709)
	    (diseqR_14 (x_56474 x_56706 x_56707) (x_56474 x_56708 x_56709)))))
(assert (forall ((x_56710 R_438) (x_56711 R_438))
	(=> (diseqR_14 x_56710 x_56711)
	    (diseqR_14 (Star_14 x_56710) (Star_14 x_56711)))))
...
(assert (forall ((x_56494 list_265) (bs_0 list_264) (cs_0 list_264) (x_56476 list_265) (x_56475 T_0))
	(=> (splits_0 x_56494 x_56475 x_56476)
	    (splits_0 (cons_265 (pair_95 (cons_264 x_56475 bs_0) cs_0) x_56494) x_56475 (cons_265 (pair_95 bs_0 cs_0) x_56476)))))
...
(assert (forall ((x_56497 list_265) (x_56498 list_265) (y_2405 T_0) (xs_697 list_264))
	(=>	(and (splits_1 x_56497 xs_697)
			(splits_0 x_56498 y_2405 x_56497))
		(splits_1 (cons_265 (pair_95 nil_294 (cons_264 y_2405 xs_697)) x_56498) (cons_264 y_2405 xs_697)))))
...
(assert (forall ((x_56500 Bool_365) (x_56501 Bool_365) (y_2406 Bool_365) (xs_698 list_263))
	(=>	(and (or_372 x_56501 xs_698)
			(or_373 x_56500 y_2406 x_56501))
		(or_372 x_56500 (cons_263 y_2406 xs_698)))))
...
(assert (forall ((x_56504 Bool_365) (x_56505 Bool_365) (x_56506 Bool_365) (r_439 R_438) (q_131 R_438))
	(=>	(and (eps_29 x_56505 r_439)
			(eps_29 x_56506 q_131)
			(and_365 x_56504 x_56505 x_56506))
		(eps_29 x_56504 (x_56474 r_439 q_131)))))
(assert (forall ((x_56507 Bool_365) (x_56508 Bool_365) (x_56509 Bool_365) (p_403 R_438) (q_132 R_438))
	(=>	(and (eps_29 x_56508 p_403)
			(eps_29 x_56509 q_132)
			(or_373 x_56507 x_56508 x_56509))
		(eps_29 x_56507 (x_56473 p_403 q_132)))))
...
(assert (forall ((x_56514 R_438) (p_404 R_438) (y_2408 T_0))
	(=> (step_14 x_56514 p_404 y_2408)
	    (step_14 (x_56474 x_56514 (Star_14 p_404)) (Star_14 p_404) y_2408))))
(assert (forall ((x_56517 R_438) (x_56518 R_438) (r_440 R_438) (q_133 R_438) (y_2408 T_0))
	(=>	(and (step_14 x_56517 r_440 y_2408)
			(step_14 x_56518 q_133 y_2408)
			(eps_29 true_365 r_440))
		(step_14 (x_56473 (x_56474 x_56517 q_133) x_56518) (x_56474 r_440 q_133) y_2408))))
(assert (forall ((x_56521 R_438) (r_440 R_438) (q_133 R_438) (y_2408 T_0))
	(=>	(and (step_14 x_56521 r_440 y_2408)
			(eps_29 false_365 r_440))
		(step_14 (x_56473 (x_56474 x_56521 q_133) Nil_296) (x_56474 r_440 q_133) y_2408))))
(assert (forall ((x_56523 R_438) (x_56524 R_438) (p_405 R_438) (q_134 R_438) (y_2408 T_0))
	(=>	(and (step_14 x_56523 p_405 y_2408)
			(step_14 x_56524 q_134 y_2408))
		(step_14 (x_56473 x_56523 x_56524) (x_56473 p_405 q_134) y_2408))))
(assert (forall ((b_35 T_0))
	(step_14 Eps_28 (Atom_14 b_35) b_35)))
(assert (forall ((b_35 T_0) (y_2408 T_0))
	(=> (diseqT_0 b_35 y_2408)
	    (step_14 Nil_296 (Atom_14 b_35) y_2408))))
...
(assert (forall ((x_56529 Bool_365) (x_56530 R_438) (z_2171 T_0) (xs_699 list_264) (x_56483 R_438))
	(=>	(and (step_14 x_56530 x_56483 z_2171)
			(rec_0 x_56529 x_56530 xs_699))
		(rec_0 x_56529 x_56483 (cons_264 z_2171 xs_699)))))
(assert (forall ((x_56532 Bool_365) (x_56483 R_438))
	(=> (eps_29 x_56532 x_56483)
	    (rec_0 x_56532 x_56483 nil_294))))
...
(assert (forall ((x_56535 Bool_365) (x_56485 T_0) (x_56486 list_264) (p_406 R_438))
	(=>	(and (rec_0 x_56535 (x_56474 p_406 (Star_14 p_406)) (cons_264 x_56485 x_56486))
			(eps_29 false_365 p_406))
		(reck_0 x_56535 (Star_14 p_406) (cons_264 x_56485 x_56486)))))
(assert (forall ((x_56485 T_0) (x_56486 list_264) (p_406 R_438))
	(=> (eps_29 true_365 p_406)
	    (reck_0 false_365 (Star_14 p_406) (cons_264 x_56485 x_56486)))))
...
(assert (forall ((x_56540 Bool_365) (x_56541 list_265) (x_56542 list_263) (r_441 R_438) (q_135 R_438) (y_2410 list_264))
	(=>	(and (splits_1 x_56541 y_2410)
			(reck_1 x_56542 r_441 q_135 x_56541)
			(or_372 x_56540 x_56542))
		(reck_0 x_56540 (x_56474 r_441 q_135) y_2410))))
(assert (forall ((x_56544 Bool_365) (x_56545 Bool_365) (x_56546 Bool_365) (p_407 R_438) (q_136 R_438) (y_2410 list_264))
	(=>	(and (reck_0 x_56545 p_407 y_2410)
			(reck_0 x_56546 q_136 y_2410)
			(or_373 x_56544 x_56545 x_56546))
		(reck_0 x_56544 (x_56473 p_407 q_136) y_2410))))
...
(assert (forall ((b_36 T_0) (c_22 T_0))
	(=> (diseqT_0 c_22 b_36)
	    (reck_0 false_365 (Atom_14 c_22) (cons_264 b_36 nil_294)))))
...
(assert (forall ((x_56564 Bool_365) (x_56555 Bool_365) (x_56556 Bool_365) (x_56557 list_263) (l_43 list_264) (r_442 list_264) (z_2173 list_265) (p_408 R_438) (q_137 R_438))
	(=>	(and (reck_0 x_56555 p_408 l_43)
			(rec_0 x_56556 q_137 r_442)
			(reck_1 x_56557 p_408 q_137 z_2173)
			(and_365 x_56564 x_56555 x_56556))
		(reck_1 (cons_263 x_56564 x_56557) p_408 q_137 (cons_265 (pair_95 l_43 r_442) z_2173)))))
(assert (forall ((p_408 R_438) (q_137 R_438))
	(reck_1 nil_293 p_408 q_137 nil_295)))
(assert (forall ((p_409 R_438))
	(=>	(and true
			(reck_0 true_365 p_409 (cons_264 A_53 (cons_264 B_34 (cons_264 A_53 (cons_264 B_34 (cons_264 B_34 nil_294)))))))
		false)))
(check-sat)
