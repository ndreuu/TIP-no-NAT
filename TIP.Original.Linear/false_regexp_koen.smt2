...
(assert (forall ((x_108206 T_28) (x_108207 list_360) (x_108208 T_28) (x_108209 list_360))
	(=> (diseqT_26 x_108206 x_108208)
	    (diseqlist_354 (cons_354 x_108206 x_108207) (cons_354 x_108208 x_108209)))))
(assert (forall ((x_108206 T_28) (x_108207 list_360) (x_108208 T_28) (x_108209 list_360))
	(=> (diseqlist_354 x_108207 x_108209)
	    (diseqlist_354 (cons_354 x_108206 x_108207) (cons_354 x_108208 x_108209)))))
...
(assert (forall ((x_108288 T_28) (x_108289 T_28))
	(=> (diseqT_26 x_108288 x_108289)
	    (diseqR_40 (Atom_40 x_108288) (Atom_40 x_108289)))))
(assert (forall ((x_108290 R_597) (x_108291 R_597) (x_108292 R_597) (x_108293 R_597))
	(=> (diseqR_40 x_108290 x_108292)
	    (diseqR_40 (x_108147 x_108290 x_108291) (x_108147 x_108292 x_108293)))))
(assert (forall ((x_108290 R_597) (x_108291 R_597) (x_108292 R_597) (x_108293 R_597))
	(=> (diseqR_40 x_108291 x_108293)
	    (diseqR_40 (x_108147 x_108290 x_108291) (x_108147 x_108292 x_108293)))))
(assert (forall ((x_108294 R_597) (x_108295 R_597) (x_108296 R_597) (x_108297 R_597))
	(=> (diseqR_40 x_108294 x_108296)
	    (diseqR_40 (x_108148 x_108294 x_108295) (x_108148 x_108296 x_108297)))))
(assert (forall ((x_108294 R_597) (x_108295 R_597) (x_108296 R_597) (x_108297 R_597))
	(=> (diseqR_40 x_108295 x_108297)
	    (diseqR_40 (x_108148 x_108294 x_108295) (x_108148 x_108296 x_108297)))))
(assert (forall ((x_108298 R_597) (x_108299 R_597))
	(=> (diseqR_40 x_108298 x_108299)
	    (diseqR_40 (Star_40 x_108298) (Star_40 x_108299)))))
...
(assert (forall ((x_108156 Bool_421) (x_108157 Bool_421) (x_108158 Bool_421) (r_598 R_597) (q_307 R_597))
	(=>	(and (eps_81 x_108157 r_598)
			(eps_81 x_108158 q_307)
			(and_426 x_108156 x_108157 x_108158))
		(eps_81 x_108156 (x_108148 r_598 q_307)))))
(assert (forall ((x_108159 Bool_421) (x_108160 Bool_421) (x_108161 Bool_421) (p_547 R_597) (q_308 R_597))
	(=>	(and (eps_81 x_108160 p_547)
			(eps_81 x_108161 q_308)
			(or_436 x_108159 x_108160 x_108161))
		(eps_81 x_108159 (x_108147 p_547 q_308)))))
...
(assert (forall ((x_108166 R_597) (p_548 R_597) (y_2973 T_28))
	(=> (step_40 x_108166 p_548 y_2973)
	    (step_40 (x_108148 x_108166 (Star_40 p_548)) (Star_40 p_548) y_2973))))
(assert (forall ((x_108169 R_597) (x_108170 R_597) (r_599 R_597) (q_309 R_597) (y_2973 T_28))
	(=>	(and (step_40 x_108169 r_599 y_2973)
			(step_40 x_108170 q_309 y_2973)
			(eps_81 true_421 r_599))
		(step_40 (x_108147 (x_108148 x_108169 q_309) x_108170) (x_108148 r_599 q_309) y_2973))))
(assert (forall ((x_108173 R_597) (r_599 R_597) (q_309 R_597) (y_2973 T_28))
	(=>	(and (step_40 x_108173 r_599 y_2973)
			(eps_81 false_421 r_599))
		(step_40 (x_108147 (x_108148 x_108173 q_309) Nil_411) (x_108148 r_599 q_309) y_2973))))
(assert (forall ((x_108175 R_597) (x_108176 R_597) (p_549 R_597) (q_310 R_597) (y_2973 T_28))
	(=>	(and (step_40 x_108175 p_549 y_2973)
			(step_40 x_108176 q_310 y_2973))
		(step_40 (x_108147 x_108175 x_108176) (x_108147 p_549 q_310) y_2973))))
(assert (forall ((b_115 T_28))
	(step_40 Eps_80 (Atom_40 b_115) b_115)))
(assert (forall ((b_115 T_28) (y_2973 T_28))
	(=> (diseqT_26 b_115 y_2973)
	    (step_40 Nil_411 (Atom_40 b_115) y_2973))))
...
(assert (forall ((x_108181 Bool_421) (x_108182 R_597) (z_2582 T_28) (xs_852 list_360) (x_108153 R_597))
	(=>	(and (step_40 x_108182 x_108153 z_2582)
			(rec_26 x_108181 x_108182 xs_852))
		(rec_26 x_108181 x_108153 (cons_354 z_2582 xs_852)))))
(assert (forall ((x_108184 Bool_421) (x_108153 R_597))
	(=> (eps_81 x_108184 x_108153)
	    (rec_26 x_108184 x_108153 nil_410))))
(assert (forall ((x_108186 Bool_421) (x_108187 Bool_421) (p_550 R_597) (q_311 R_597) (s_597 list_360))
	(=>	(and true
			(diseqBool_206 x_108186 x_108187)
			(rec_26 x_108186 (x_108148 p_550 q_311) s_597)
			(rec_26 x_108187 (x_108148 q_311 p_550) s_597))
		false)))
(check-sat)
