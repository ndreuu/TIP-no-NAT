...
(assert (forall ((x_30874 A_32) (x_30875 A_32))
	(=> (diseqA_7 x_30874 x_30875)
	    (diseqR_7 (Atom_7 x_30874) (Atom_7 x_30875)))))
(assert (forall ((x_30876 R_233) (x_30877 R_233) (x_30878 R_233) (x_30879 R_233))
	(=> (diseqR_7 x_30876 x_30878)
	    (diseqR_7 (Plus_65 x_30876 x_30877) (Plus_65 x_30878 x_30879)))))
(assert (forall ((x_30876 R_233) (x_30877 R_233) (x_30878 R_233) (x_30879 R_233))
	(=> (diseqR_7 x_30877 x_30879)
	    (diseqR_7 (Plus_65 x_30876 x_30877) (Plus_65 x_30878 x_30879)))))
(assert (forall ((x_30880 R_233) (x_30881 R_233) (x_30882 R_233) (x_30883 R_233))
	(=> (diseqR_7 x_30880 x_30882)
	    (diseqR_7 (Seq_14 x_30880 x_30881) (Seq_14 x_30882 x_30883)))))
(assert (forall ((x_30880 R_233) (x_30881 R_233) (x_30882 R_233) (x_30883 R_233))
	(=> (diseqR_7 x_30881 x_30883)
	    (diseqR_7 (Seq_14 x_30880 x_30881) (Seq_14 x_30882 x_30883)))))
(assert (forall ((x_30884 R_233) (x_30885 R_233))
	(=> (diseqR_7 x_30884 x_30885)
	    (diseqR_7 (Star_7 x_30884) (Star_7 x_30885)))))
...
(assert (forall ((x_30896 A_32) (x_30897 list_136) (x_30898 A_32) (x_30899 list_136))
	(=> (diseqA_7 x_30896 x_30898)
	    (diseqlist_136 (cons_136 x_30896 x_30897) (cons_136 x_30898 x_30899)))))
(assert (forall ((x_30896 A_32) (x_30897 list_136) (x_30898 A_32) (x_30899 list_136))
	(=> (diseqlist_136 x_30897 x_30899)
	    (diseqlist_136 (cons_136 x_30896 x_30897) (cons_136 x_30898 x_30899)))))
...
(assert (forall ((x_30749 Bool_198) (x_30750 Bool_198) (x_30751 Bool_198) (r_234 R_233) (q_62 R_233))
	(=>	(and (eps_15 x_30750 r_234)
			(eps_15 x_30751 q_62)
			(and_198 x_30749 x_30750 x_30751))
		(eps_15 x_30749 (Seq_14 r_234 q_62)))))
(assert (forall ((x_30752 Bool_198) (x_30753 Bool_198) (x_30754 Bool_198) (p_197 R_233) (q_63 R_233))
	(=>	(and (eps_15 x_30753 p_197)
			(eps_15 x_30754 q_63)
			(or_201 x_30752 x_30753 x_30754))
		(eps_15 x_30752 (Plus_65 p_197 q_63)))))
...
(assert (forall ((x_28721 R_233))
	(=> (eps_15 true_198 x_28721)
	    (epsR_7 Eps_14 x_28721))))
(assert (forall ((x_28721 R_233))
	(=> (eps_15 false_198 x_28721)
	    (epsR_7 Nil_151 x_28721))))
(declare-fun step_7 (R_233 R_233 A_32) Bool)
(assert (forall ((x_30762 R_233) (x_30763 R_233) (p_198 R_233) (y_1212 A_32))
	(=>	(and (step_7 x_30763 p_198 y_1212)
			(seq_15 x_30762 x_30763 (Star_7 p_198)))
		(step_7 x_30762 (Star_7 p_198) y_1212))))
(assert (forall ((x_30765 R_233) (x_30766 R_233) (x_30767 R_233) (x_30768 R_233) (x_30769 R_233) (x_30770 R_233) (r_235 R_233) (q_64 R_233) (y_1212 A_32))
	(=>	(and (step_7 x_30766 r_235 y_1212)
			(seq_15 x_30767 x_30766 q_64)
			(epsR_7 x_30768 r_235)
			(step_7 x_30769 q_64 y_1212)
			(seq_15 x_30770 x_30768 x_30769)
			(plus_66 x_30765 x_30767 x_30770))
		(step_7 x_30765 (Seq_14 r_235 q_64) y_1212))))
(assert (forall ((x_30772 R_233) (x_30773 R_233) (x_30774 R_233) (p_199 R_233) (q_65 R_233) (y_1212 A_32))
	(=>	(and (step_7 x_30773 p_199 y_1212)
			(step_7 x_30774 q_65 y_1212)
			(plus_66 x_30772 x_30773 x_30774))
		(step_7 x_30772 (Plus_65 p_199 q_65) y_1212))))
(assert (forall ((a_33 A_32) (y_1212 A_32))
	(=> (eqA_7 true_198 a_33 y_1212)
	    (step_7 Eps_14 (Atom_7 a_33) y_1212))))
(assert (forall ((a_33 A_32) (y_1212 A_32))
	(=> (eqA_7 false_198 a_33 y_1212)
	    (step_7 Nil_151 (Atom_7 a_33) y_1212))))
...
(assert (forall ((x_30782 Bool_198) (x_30783 R_233) (z_1139 A_32) (xs_370 list_136) (x_28724 R_233))
	(=>	(and (step_7 x_30783 x_28724 z_1139)
			(recognise_7 x_30782 x_30783 xs_370))
		(recognise_7 x_30782 x_28724 (cons_136 z_1139 xs_370)))))
(assert (forall ((x_30785 Bool_198) (x_28724 R_233))
	(=> (eps_15 x_30785 x_28724)
	    (recognise_7 x_30785 x_28724 nil_152))))
(assert (forall ((x_30787 Bool_198) (x_30788 Bool_198) (p_200 R_233) (s_290 list_136))
	(=>	(and true
			(diseqBool_86 x_30787 x_30788)
			(recognise_7 x_30787 (Plus_65 p_200 p_200) s_290)
			(recognise_7 x_30788 p_200 s_290))
		false)))
(check-sat)
