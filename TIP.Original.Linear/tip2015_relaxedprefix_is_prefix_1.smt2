...
(assert (forall ((x_35285 It_2) (x_35286 list_152) (x_35287 It_2) (x_35288 list_152))
	(=> (diseqIt_2 x_35285 x_35287)
	    (diseqlist_152 (cons_152 x_35285 x_35286) (cons_152 x_35287 x_35288)))))
(assert (forall ((x_35285 It_2) (x_35286 list_152) (x_35287 It_2) (x_35288 list_152))
	(=> (diseqlist_152 x_35286 x_35288)
	    (diseqlist_152 (cons_152 x_35285 x_35286) (cons_152 x_35287 x_35288)))))
...
(assert (forall ((x_35252 Bool_223) (x_35242 It_2) (x_35243 list_152) (x_35241 list_152))
	(=> (isPrefix_2 x_35252 x_35241 x_35243)
	    (isPrefix_2 x_35252 (cons_152 x_35242 x_35241) (cons_152 x_35242 x_35243)))))
(assert (forall ((x_35242 It_2) (x_35243 list_152) (z_1323 It_2) (x_35241 list_152))
	(=> (diseqIt_2 z_1323 x_35242)
	    (isPrefix_2 false_223 (cons_152 z_1323 x_35241) (cons_152 x_35242 x_35243)))))
...
(assert (forall ((x_35257 Bool_223) (x_35248 It_2) (x_35249 list_152) (x_35246 It_2) (x_35247 list_152))
	(=> (isRelaxedPrefix_2 x_35257 (cons_152 x_35246 x_35247) x_35249)
	    (isRelaxedPrefix_2 x_35257 (cons_152 x_35248 (cons_152 x_35246 x_35247)) (cons_152 x_35248 x_35249)))))
(assert (forall ((x_35259 Bool_223) (x_35248 It_2) (x_35249 list_152) (x_35246 It_2) (x_35247 list_152) (z_1324 It_2))
	(=>	(and (diseqIt_2 z_1324 x_35248)
			(isPrefix_2 x_35259 (cons_152 x_35246 x_35247) (cons_152 x_35248 x_35249)))
		(isRelaxedPrefix_2 x_35259 (cons_152 z_1324 (cons_152 x_35246 x_35247)) (cons_152 x_35248 x_35249)))))
...
(assert (forall ((x_35265 list_152) (z_1325 It_2) (xs_425 list_152) (y_1434 list_152))
	(=> (x_35250 x_35265 xs_425 y_1434)
	    (x_35250 (cons_152 z_1325 x_35265) (cons_152 z_1325 xs_425) y_1434))))
...
(assert (forall ((x_35267 list_152) (xs_426 list_152) (ys_136 list_152))
	(=>	(and true
			(x_35250 x_35267 xs_426 ys_136)
			(isRelaxedPrefix_2 false_223 xs_426 x_35267))
		false)))
(check-sat)
