...
(assert (forall ((x_128045 Tok_5) (x_128046 list_421) (x_128047 Tok_5) (x_128048 list_421))
	(=> (diseqTok_5 x_128045 x_128047)
	    (diseqlist_415 (cons_415 x_128045 x_128046) (cons_415 x_128047 x_128048)))))
(assert (forall ((x_128045 Tok_5) (x_128046 list_421) (x_128047 Tok_5) (x_128048 list_421))
	(=> (diseqlist_415 x_128046 x_128048)
	    (diseqlist_415 (cons_415 x_128045 x_128046) (cons_415 x_128047 x_128048)))))
...
(assert (forall ((x_128055 B_152) (x_128056 B_152))
	(=> (diseqB_5 x_128055 x_128056)
	    (diseqB_5 (SB_0 x_128055) (SB_0 x_128056)))))
...
(assert (forall ((x_128063 A_135) (x_128064 A_135))
	(=> (diseqA_14 x_128063 x_128064)
	    (diseqA_14 (SA_0 x_128063) (SA_0 x_128064)))))
...
(assert (forall ((x_128075 A_135) (x_128076 A_135))
	(=> (diseqA_14 x_128075 x_128076)
	    (diseqS_0 (A_136 x_128075) (A_136 x_128076)))))
(assert (forall ((x_128077 B_152) (x_128078 B_152))
	(=> (diseqB_5 x_128077 x_128078)
	    (diseqS_0 (B_153 x_128077) (B_153 x_128078)))))
...
(assert (forall ((x_128013 list_421) (z_2816 Tok_5) (xs_919 list_421) (y_3285 list_421))
	(=> (x_128007 x_128013 xs_919 y_3285)
	    (x_128007 (cons_415 z_2816 x_128013) (cons_415 z_2816 xs_919) y_3285))))
...
(assert (forall ((x_128016 list_421) (x_128017 list_421) (x_128018 list_421) (a_137 A_135))
	(=>	(and (linA_0 x_128017 a_137)
			(x_128007 x_128018 x_128017 (cons_415 Y_3284 nil_483))
			(x_128007 x_128016 (cons_415 X_128006 nil_483) x_128018))
		(linA_0 x_128016 (SA_0 a_137)))))
...
(assert (forall ((x_128021 list_421) (x_128022 list_421) (x_128023 list_421) (b_154 B_152))
	(=>	(and (linB_0 x_128022 b_154)
			(x_128007 x_128023 x_128022 (cons_415 Y_3284 (cons_415 Y_3284 nil_483)))
			(x_128007 x_128021 (cons_415 X_128006 nil_483) x_128023))
		(linB_0 x_128021 (SB_0 b_154)))))
(declare-fun linS_0 (list_421 S_648) Bool)
(assert (forall ((x_128025 list_421) (b_155 B_152))
	(=> (linB_0 x_128025 b_155)
	    (linS_0 x_128025 (B_153 b_155)))))
(assert (forall ((x_128027 list_421) (a_138 A_135))
	(=> (linA_0 x_128027 a_138)
	    (linS_0 x_128027 (A_136 a_138)))))
(assert (forall ((x_128029 list_421) (u_39 S_648) (v_40 S_648))
	(=>	(and true
			(diseqS_0 u_39 v_40)
			(linS_0 x_128029 u_39)
			(linS_0 x_128029 v_40))
		false)))
(check-sat)
