...
(assert (forall ((x_127223 T_41) (x_127224 list_409) (x_127225 T_41) (x_127226 list_409))
	(=> (diseqT_37 x_127223 x_127225)
	    (diseqlist_403 (cons_403 x_127223 x_127224) (cons_403 x_127225 x_127226)))))
(assert (forall ((x_127223 T_41) (x_127224 list_409) (x_127225 T_41) (x_127226 list_409))
	(=> (diseqlist_403 x_127224 x_127226)
	    (diseqlist_403 (cons_403 x_127223 x_127224) (cons_403 x_127225 x_127226)))))
...
(assert (forall ((x_127305 T_41) (x_127306 T_41))
	(=> (diseqT_37 x_127305 x_127306)
	    (diseqR_51 (Atom_51 x_127305) (Atom_51 x_127306)))))
(assert (forall ((x_127307 R_674) (x_127308 R_674) (x_127309 R_674) (x_127310 R_674))
	(=> (diseqR_51 x_127307 x_127309)
	    (diseqR_51 (x_127165 x_127307 x_127308) (x_127165 x_127309 x_127310)))))
(assert (forall ((x_127307 R_674) (x_127308 R_674) (x_127309 R_674) (x_127310 R_674))
	(=> (diseqR_51 x_127308 x_127310)
	    (diseqR_51 (x_127165 x_127307 x_127308) (x_127165 x_127309 x_127310)))))
(assert (forall ((x_127311 R_674) (x_127312 R_674) (x_127313 R_674) (x_127314 R_674))
	(=> (diseqR_51 x_127311 x_127313)
	    (diseqR_51 (x_127166 x_127311 x_127312) (x_127166 x_127313 x_127314)))))
(assert (forall ((x_127311 R_674) (x_127312 R_674) (x_127313 R_674) (x_127314 R_674))
	(=> (diseqR_51 x_127312 x_127314)
	    (diseqR_51 (x_127166 x_127311 x_127312) (x_127166 x_127313 x_127314)))))
(assert (forall ((x_127315 R_674) (x_127316 R_674))
	(=> (diseqR_51 x_127315 x_127316)
	    (diseqR_51 (Star_51 x_127315) (Star_51 x_127316)))))
...
(assert (forall ((x_127174 Bool_447) (x_127175 Bool_447) (x_127176 Bool_447) (r_675 R_674) (q_387 R_674))
	(=>	(and (eps_103 x_127175 r_675)
			(eps_103 x_127176 q_387)
			(and_453 x_127174 x_127175 x_127176))
		(eps_103 x_127174 (x_127166 r_675 q_387)))))
(assert (forall ((x_127177 Bool_447) (x_127178 Bool_447) (x_127179 Bool_447) (p_620 R_674) (q_388 R_674))
	(=>	(and (eps_103 x_127178 p_620)
			(eps_103 x_127179 q_388)
			(or_469 x_127177 x_127178 x_127179))
		(eps_103 x_127177 (x_127165 p_620 q_388)))))
...
(assert (forall ((x_127184 R_674) (p_621 R_674) (y_3242 T_41))
	(=> (step_51 x_127184 p_621 y_3242)
	    (step_51 (x_127166 x_127184 (Star_51 p_621)) (Star_51 p_621) y_3242))))
(assert (forall ((x_127187 R_674) (x_127188 R_674) (r_676 R_674) (q_389 R_674) (y_3242 T_41))
	(=>	(and (step_51 x_127187 r_676 y_3242)
			(step_51 x_127188 q_389 y_3242)
			(eps_103 true_447 r_676))
		(step_51 (x_127165 (x_127166 x_127187 q_389) x_127188) (x_127166 r_676 q_389) y_3242))))
(assert (forall ((x_127191 R_674) (r_676 R_674) (q_389 R_674) (y_3242 T_41))
	(=>	(and (step_51 x_127191 r_676 y_3242)
			(eps_103 false_447 r_676))
		(step_51 (x_127165 (x_127166 x_127191 q_389) Nil_471) (x_127166 r_676 q_389) y_3242))))
(assert (forall ((x_127193 R_674) (x_127194 R_674) (p_622 R_674) (q_390 R_674) (y_3242 T_41))
	(=>	(and (step_51 x_127193 p_622 y_3242)
			(step_51 x_127194 q_390 y_3242))
		(step_51 (x_127165 x_127193 x_127194) (x_127165 p_622 q_390) y_3242))))
(assert (forall ((b_147 T_41))
	(step_51 Eps_102 (Atom_51 b_147) b_147)))
(assert (forall ((b_147 T_41) (y_3242 T_41))
	(=> (diseqT_37 b_147 y_3242)
	    (step_51 Nil_471 (Atom_51 b_147) y_3242))))
...
(assert (forall ((x_127199 Bool_447) (x_127200 R_674) (z_2778 T_41) (xs_907 list_409) (x_127171 R_674))
	(=>	(and (step_51 x_127200 x_127171 z_2778)
			(rec_37 x_127199 x_127200 xs_907))
		(rec_37 x_127199 x_127171 (cons_403 z_2778 xs_907)))))
(assert (forall ((x_127202 Bool_447) (x_127171 R_674))
	(=> (eps_103 x_127202 x_127171)
	    (rec_37 x_127202 x_127171 nil_470))))
(assert (forall ((p_623 R_674))
	(=>	(and true
			(rec_37 true_447 p_623 (cons_403 A_126 (cons_403 B_146 (cons_403 A_126 (cons_403 B_146 (cons_403 A_126 (cons_403 B_146 nil_470))))))))
		false)))
(check-sat)
