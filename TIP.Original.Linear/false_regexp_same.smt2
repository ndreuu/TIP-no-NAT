...
(assert (forall ((x_106478 Bool_417) (x_106479 list_352) (x_106480 Bool_417) (x_106481 list_352))
	(=> (diseqBool_203 x_106478 x_106480)
	    (diseqlist_347 (cons_347 x_106478 x_106479) (cons_347 x_106480 x_106481)))))
(assert (forall ((x_106478 Bool_417) (x_106479 list_352) (x_106480 Bool_417) (x_106481 list_352))
	(=> (diseqlist_347 x_106479 x_106481)
	    (diseqlist_347 (cons_347 x_106478 x_106479) (cons_347 x_106480 x_106481)))))
...
(assert (forall ((x_106495 T_26) (x_106496 list_353) (x_106497 T_26) (x_106498 list_353))
	(=> (diseqT_25 x_106495 x_106497)
	    (diseqlist_348 (cons_348 x_106495 x_106496) (cons_348 x_106497 x_106498)))))
(assert (forall ((x_106495 T_26) (x_106496 list_353) (x_106497 T_26) (x_106498 list_353))
	(=> (diseqlist_348 x_106496 x_106498)
	    (diseqlist_348 (cons_348 x_106495 x_106496) (cons_348 x_106497 x_106498)))))
...
(assert (forall ((x_106504 list_353) (x_106505 list_353) (x_106506 list_353) (x_106507 list_353))
	(=> (diseqlist_348 x_106504 x_106506)
	    (diseqpair_75 (pair_151 x_106504 x_106505) (pair_151 x_106506 x_106507)))))
(assert (forall ((x_106504 list_353) (x_106505 list_353) (x_106506 list_353) (x_106507 list_353))
	(=> (diseqlist_348 x_106505 x_106507)
	    (diseqpair_75 (pair_151 x_106504 x_106505) (pair_151 x_106506 x_106507)))))
...
(assert (forall ((x_106518 pair_150) (x_106519 list_354) (x_106520 pair_150) (x_106521 list_354))
	(=> (diseqpair_75 x_106518 x_106520)
	    (diseqlist_349 (cons_349 x_106518 x_106519) (cons_349 x_106520 x_106521)))))
(assert (forall ((x_106518 pair_150) (x_106519 list_354) (x_106520 pair_150) (x_106521 list_354))
	(=> (diseqlist_349 x_106519 x_106521)
	    (diseqlist_349 (cons_349 x_106518 x_106519) (cons_349 x_106520 x_106521)))))
...
(assert (forall ((x_106600 T_26) (x_106601 T_26))
	(=> (diseqT_25 x_106600 x_106601)
	    (diseqR_39 (Atom_39 x_106600) (Atom_39 x_106601)))))
(assert (forall ((x_106602 R_582) (x_106603 R_582) (x_106604 R_582) (x_106605 R_582))
	(=> (diseqR_39 x_106602 x_106604)
	    (diseqR_39 (x_106352 x_106602 x_106603) (x_106352 x_106604 x_106605)))))
(assert (forall ((x_106602 R_582) (x_106603 R_582) (x_106604 R_582) (x_106605 R_582))
	(=> (diseqR_39 x_106603 x_106605)
	    (diseqR_39 (x_106352 x_106602 x_106603) (x_106352 x_106604 x_106605)))))
(assert (forall ((x_106606 R_582) (x_106607 R_582) (x_106608 R_582) (x_106609 R_582))
	(=> (diseqR_39 x_106606 x_106608)
	    (diseqR_39 (x_106353 x_106606 x_106607) (x_106353 x_106608 x_106609)))))
(assert (forall ((x_106606 R_582) (x_106607 R_582) (x_106608 R_582) (x_106609 R_582))
	(=> (diseqR_39 x_106607 x_106609)
	    (diseqR_39 (x_106353 x_106606 x_106607) (x_106353 x_106608 x_106609)))))
(assert (forall ((x_106610 R_582) (x_106611 R_582))
	(=> (diseqR_39 x_106610 x_106611)
	    (diseqR_39 (Star_39 x_106610) (Star_39 x_106611)))))
...
(assert (forall ((x_106376 list_354) (bs_17 list_353) (cs_4 list_353) (x_106355 list_354) (x_106354 T_26))
	(=> (splits_6 x_106376 x_106354 x_106355)
	    (splits_6 (cons_349 (pair_151 (cons_348 x_106354 bs_17) cs_4) x_106376) x_106354 (cons_349 (pair_151 bs_17 cs_4) x_106355)))))
...
(assert (forall ((x_106379 list_354) (x_106380 list_354) (y_2882 T_26) (xs_837 list_353))
	(=>	(and (splits_7 x_106379 xs_837)
			(splits_6 x_106380 y_2882 x_106379))
		(splits_7 (cons_349 (pair_151 nil_403 (cons_348 y_2882 xs_837)) x_106380) (cons_348 y_2882 xs_837)))))
...
(assert (forall ((x_106382 Bool_417) (x_106383 Bool_417) (y_2883 Bool_417) (xs_838 list_352))
	(=>	(and (or_431 x_106383 xs_838)
			(or_432 x_106382 y_2883 x_106383))
		(or_431 x_106382 (cons_347 y_2883 xs_838)))))
...
(assert (forall ((x_106386 Bool_417) (x_106387 Bool_417) (x_106388 Bool_417) (r_583 R_582) (q_290 R_582))
	(=>	(and (eps_79 x_106387 r_583)
			(eps_79 x_106388 q_290)
			(and_421 x_106386 x_106387 x_106388))
		(eps_79 x_106386 (x_106353 r_583 q_290)))))
(assert (forall ((x_106389 Bool_417) (x_106390 Bool_417) (x_106391 Bool_417) (p_536 R_582) (q_291 R_582))
	(=>	(and (eps_79 x_106390 p_536)
			(eps_79 x_106391 q_291)
			(or_432 x_106389 x_106390 x_106391))
		(eps_79 x_106389 (x_106352 p_536 q_291)))))
...
(assert (forall ((x_106459 Bool_417) (x_106395 Bool_417) (x_106396 Bool_417) (x_106397 Bool_417) (p_537 R_582))
	(=>	(and (okay_2 x_106396 p_537)
			(eps_79 x_106397 p_537)
			(not_422 x_106459 x_106397)
			(and_421 x_106395 x_106396 x_106459))
		(okay_2 x_106395 (Star_39 p_537)))))
(assert (forall ((x_106398 Bool_417) (x_106399 Bool_417) (x_106400 Bool_417) (r_584 R_582) (q_292 R_582))
	(=>	(and (okay_2 x_106399 r_584)
			(okay_2 x_106400 q_292)
			(and_421 x_106398 x_106399 x_106400))
		(okay_2 x_106398 (x_106353 r_584 q_292)))))
(assert (forall ((x_106401 Bool_417) (x_106402 Bool_417) (x_106403 Bool_417) (p_538 R_582) (q_293 R_582))
	(=>	(and (okay_2 x_106402 p_538)
			(okay_2 x_106403 q_293)
			(and_421 x_106401 x_106402 x_106403))
		(okay_2 x_106401 (x_106352 p_538 q_293)))))
...
(assert (forall ((x_106408 R_582) (p_539 R_582) (y_2885 T_26))
	(=> (step_39 x_106408 p_539 y_2885)
	    (step_39 (x_106353 x_106408 (Star_39 p_539)) (Star_39 p_539) y_2885))))
(assert (forall ((x_106411 R_582) (x_106412 R_582) (r_585 R_582) (q_294 R_582) (y_2885 T_26))
	(=>	(and (step_39 x_106411 r_585 y_2885)
			(step_39 x_106412 q_294 y_2885)
			(eps_79 true_417 r_585))
		(step_39 (x_106352 (x_106353 x_106411 q_294) x_106412) (x_106353 r_585 q_294) y_2885))))
(assert (forall ((x_106415 R_582) (r_585 R_582) (q_294 R_582) (y_2885 T_26))
	(=>	(and (step_39 x_106415 r_585 y_2885)
			(eps_79 false_417 r_585))
		(step_39 (x_106352 (x_106353 x_106415 q_294) Nil_405) (x_106353 r_585 q_294) y_2885))))
(assert (forall ((x_106417 R_582) (x_106418 R_582) (p_540 R_582) (q_295 R_582) (y_2885 T_26))
	(=>	(and (step_39 x_106417 p_540 y_2885)
			(step_39 x_106418 q_295 y_2885))
		(step_39 (x_106352 x_106417 x_106418) (x_106352 p_540 q_295) y_2885))))
(assert (forall ((b_110 T_26))
	(step_39 Eps_78 (Atom_39 b_110) b_110)))
(assert (forall ((b_110 T_26) (y_2885 T_26))
	(=> (diseqT_25 b_110 y_2885)
	    (step_39 Nil_405 (Atom_39 b_110) y_2885))))
...
(assert (forall ((x_106423 Bool_417) (x_106424 R_582) (z_2522 T_26) (xs_839 list_353) (x_106364 R_582))
	(=>	(and (step_39 x_106424 x_106364 z_2522)
			(rec_25 x_106423 x_106424 xs_839))
		(rec_25 x_106423 x_106364 (cons_348 z_2522 xs_839)))))
(assert (forall ((x_106426 Bool_417) (x_106364 R_582))
	(=> (eps_79 x_106426 x_106364)
	    (rec_25 x_106426 x_106364 nil_403))))
...
(assert (forall ((x_106429 Bool_417) (x_106366 T_26) (x_106367 list_353) (p_541 R_582))
	(=>	(and (rec_25 x_106429 (x_106353 p_541 (Star_39 p_541)) (cons_348 x_106366 x_106367))
			(eps_79 false_417 p_541))
		(reck_6 x_106429 (Star_39 p_541) (cons_348 x_106366 x_106367)))))
(assert (forall ((x_106366 T_26) (x_106367 list_353) (p_541 R_582))
	(=> (eps_79 true_417 p_541)
	    (reck_6 false_417 (Star_39 p_541) (cons_348 x_106366 x_106367)))))
...
(assert (forall ((x_106434 Bool_417) (x_106435 list_354) (x_106436 list_352) (r_586 R_582) (q_296 R_582) (y_2887 list_353))
	(=>	(and (splits_7 x_106435 y_2887)
			(reck_7 x_106436 r_586 q_296 x_106435)
			(or_431 x_106434 x_106436))
		(reck_6 x_106434 (x_106353 r_586 q_296) y_2887))))
(assert (forall ((x_106438 Bool_417) (x_106439 Bool_417) (x_106440 Bool_417) (p_542 R_582) (q_297 R_582) (y_2887 list_353))
	(=>	(and (reck_6 x_106439 p_542 y_2887)
			(reck_6 x_106440 q_297 y_2887)
			(or_432 x_106438 x_106439 x_106440))
		(reck_6 x_106438 (x_106352 p_542 q_297) y_2887))))
...
(assert (forall ((b_111 T_26) (c_60 T_26))
	(=> (diseqT_25 c_60 b_111)
	    (reck_6 false_417 (Atom_39 c_60) (cons_348 b_111 nil_403)))))
...
(assert (forall ((x_106464 Bool_417) (x_106449 Bool_417) (x_106450 Bool_417) (x_106451 list_352) (l_55 list_353) (r_587 list_353) (z_2524 list_354) (p_543 R_582) (q_298 R_582))
	(=>	(and (reck_6 x_106449 p_543 l_55)
			(rec_25 x_106450 q_298 r_587)
			(reck_7 x_106451 p_543 q_298 z_2524)
			(and_421 x_106464 x_106449 x_106450))
		(reck_7 (cons_347 x_106464 x_106451) p_543 q_298 (cons_349 (pair_151 l_55 r_587) z_2524)))))
...
(assert (forall ((x_106453 Bool_417) (x_106454 Bool_417) (p_544 R_582) (s_589 list_353))
	(=>	(and true
			(diseqBool_203 x_106453 x_106454)
			(okay_2 true_417 p_544)
			(rec_25 x_106453 p_544 s_589)
			(reck_6 x_106454 p_544 s_589))
		false)))
(check-sat)
