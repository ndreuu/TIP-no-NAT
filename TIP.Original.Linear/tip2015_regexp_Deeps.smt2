...
(assert (forall ((x_49223 A_49) (x_49224 A_49))
	(=> (diseqA_13 x_49223 x_49224)
	    (diseqR_13 (Atom_13 x_49223) (Atom_13 x_49224)))))
(assert (forall ((x_49225 R_321) (x_49226 R_321) (x_49227 R_321) (x_49228 R_321))
	(=> (diseqR_13 x_49225 x_49227)
	    (diseqR_13 (Plus_106 x_49225 x_49226) (Plus_106 x_49227 x_49228)))))
(assert (forall ((x_49225 R_321) (x_49226 R_321) (x_49227 R_321) (x_49228 R_321))
	(=> (diseqR_13 x_49226 x_49228)
	    (diseqR_13 (Plus_106 x_49225 x_49226) (Plus_106 x_49227 x_49228)))))
(assert (forall ((x_49229 R_321) (x_49230 R_321) (x_49231 R_321) (x_49232 R_321))
	(=> (diseqR_13 x_49229 x_49231)
	    (diseqR_13 (Seq_26 x_49229 x_49230) (Seq_26 x_49231 x_49232)))))
(assert (forall ((x_49229 R_321) (x_49230 R_321) (x_49231 R_321) (x_49232 R_321))
	(=> (diseqR_13 x_49230 x_49232)
	    (diseqR_13 (Seq_26 x_49229 x_49230) (Seq_26 x_49231 x_49232)))))
(assert (forall ((x_49233 R_321) (x_49234 R_321))
	(=> (diseqR_13 x_49233 x_49234)
	    (diseqR_13 (Star_13 x_49233) (Star_13 x_49234)))))
...
(assert (forall ((x_49245 A_49) (x_49246 list_185) (x_49247 A_49) (x_49248 list_185))
	(=> (diseqA_13 x_49245 x_49247)
	    (diseqlist_185 (cons_185 x_49245 x_49246) (cons_185 x_49247 x_49248)))))
(assert (forall ((x_49245 A_49) (x_49246 list_185) (x_49247 A_49) (x_49248 list_185))
	(=> (diseqlist_185 x_49246 x_49248)
	    (diseqlist_185 (cons_185 x_49245 x_49246) (cons_185 x_49247 x_49248)))))
...
(assert (forall ((x_49075 Bool_260) (x_49076 Bool_260) (x_49077 Bool_260) (r_322 R_321) (q_103 R_321))
	(=>	(and (eps_27 x_49076 r_322)
			(eps_27 x_49077 q_103)
			(and_260 x_49075 x_49076 x_49077))
		(eps_27 x_49075 (Seq_26 r_322 q_103)))))
(assert (forall ((x_49078 Bool_260) (x_49079 Bool_260) (x_49080 Bool_260) (p_299 R_321) (q_104 R_321))
	(=>	(and (eps_27 x_49079 p_299)
			(eps_27 x_49080 q_104)
			(or_265 x_49078 x_49079 x_49080))
		(eps_27 x_49078 (Plus_106 p_299 q_104)))))
...
(assert (forall ((x_47046 R_321))
	(=> (eps_27 true_260 x_47046)
	    (epsR_13 Eps_26 x_47046))))
(assert (forall ((x_47046 R_321))
	(=> (eps_27 false_260 x_47046)
	    (epsR_13 Nil_210 x_47046))))
(declare-fun step_13 (R_321 R_321 A_49) Bool)
(assert (forall ((x_49088 R_321) (x_49089 R_321) (p_300 R_321) (y_1713 A_49))
	(=>	(and (step_13 x_49089 p_300 y_1713)
			(seq_27 x_49088 x_49089 (Star_13 p_300)))
		(step_13 x_49088 (Star_13 p_300) y_1713))))
(assert (forall ((x_49091 R_321) (x_49092 R_321) (x_49093 R_321) (x_49094 R_321) (x_49095 R_321) (x_49096 R_321) (r_323 R_321) (q_105 R_321) (y_1713 A_49))
	(=>	(and (step_13 x_49092 r_323 y_1713)
			(seq_27 x_49093 x_49092 q_105)
			(epsR_13 x_49094 r_323)
			(step_13 x_49095 q_105 y_1713)
			(seq_27 x_49096 x_49094 x_49095)
			(plus_107 x_49091 x_49093 x_49096))
		(step_13 x_49091 (Seq_26 r_323 q_105) y_1713))))
(assert (forall ((x_49098 R_321) (x_49099 R_321) (x_49100 R_321) (p_301 R_321) (q_106 R_321) (y_1713 A_49))
	(=>	(and (step_13 x_49099 p_301 y_1713)
			(step_13 x_49100 q_106 y_1713)
			(plus_107 x_49098 x_49099 x_49100))
		(step_13 x_49098 (Plus_106 p_301 q_106) y_1713))))
(assert (forall ((a_50 A_49) (y_1713 A_49))
	(=> (eqA_13 true_260 a_50 y_1713)
	    (step_13 Eps_26 (Atom_13 a_50) y_1713))))
(assert (forall ((a_50 A_49) (y_1713 A_49))
	(=> (eqA_13 false_260 a_50 y_1713)
	    (step_13 Nil_210 (Atom_13 a_50) y_1713))))
...
(assert (forall ((x_49108 Bool_260) (x_49109 R_321) (z_1536 A_49) (xs_510 list_185) (x_47049 R_321))
	(=>	(and (step_13 x_49109 x_47049 z_1536)
			(recognise_13 x_49108 x_49109 xs_510))
		(recognise_13 x_49108 x_47049 (cons_185 z_1536 xs_510)))))
(assert (forall ((x_49111 Bool_260) (x_47049 R_321))
	(=> (eps_27 x_49111 x_47049)
	    (recognise_13 x_49111 x_47049 nil_211))))
(declare-fun deeps_0 (R_321 R_321) Bool)
(assert (forall ((x_49113 R_321) (p_302 R_321))
	(=> (deeps_0 x_49113 p_302)
	    (deeps_0 x_49113 (Star_13 p_302)))))
(assert (forall ((x_49118 R_321) (x_49119 R_321) (r_324 R_321) (q_107 R_321))
	(=>	(and (deeps_0 x_49118 r_324)
			(deeps_0 x_49119 q_107)
			(eps_27 true_260 q_107)
			(eps_27 true_260 r_324))
		(deeps_0 (Plus_106 x_49118 x_49119) (Seq_26 r_324 q_107)))))
(assert (forall ((r_324 R_321) (q_107 R_321))
	(=> (eps_27 false_260 r_324)
	    (deeps_0 (Seq_26 r_324 q_107) (Seq_26 r_324 q_107)))))
(assert (forall ((x_49125 R_321) (x_49126 R_321) (r_324 R_321) (q_107 R_321))
	(=>	(and (deeps_0 x_49125 r_324)
			(deeps_0 x_49126 q_107)
			(eps_27 true_260 q_107)
			(eps_27 true_260 r_324))
		(deeps_0 (Plus_106 x_49125 x_49126) (Seq_26 r_324 q_107)))))
(assert (forall ((r_324 R_321) (q_107 R_321))
	(=> (eps_27 false_260 q_107)
	    (deeps_0 (Seq_26 r_324 q_107) (Seq_26 r_324 q_107)))))
(assert (forall ((x_49130 R_321) (x_49131 R_321) (p_303 R_321) (q_108 R_321))
	(=>	(and (deeps_0 x_49130 p_303)
			(deeps_0 x_49131 q_108))
		(deeps_0 (Plus_106 x_49130 x_49131) (Plus_106 p_303 q_108)))))
...
(assert (forall ((x_49135 Bool_260) (x_49136 R_321) (x_49137 Bool_260) (p_304 R_321) (s_362 list_185))
	(=>	(and true
			(diseqBool_119 x_49135 x_49137)
			(recognise_13 x_49135 (Star_13 p_304) s_362)
			(deeps_0 x_49136 p_304)
			(recognise_13 x_49137 (Star_13 x_49136) s_362))
		false)))
(check-sat)
