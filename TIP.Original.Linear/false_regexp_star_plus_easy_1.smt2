...
(assert (forall ((x_125539 T_37) (x_125540 list_390) (x_125541 T_37) (x_125542 list_390))
	(=> (diseqT_33 x_125539 x_125541)
	    (diseqlist_384 (cons_384 x_125539 x_125540) (cons_384 x_125541 x_125542)))))
(assert (forall ((x_125539 T_37) (x_125540 list_390) (x_125541 T_37) (x_125542 list_390))
	(=> (diseqlist_384 x_125540 x_125542)
	    (diseqlist_384 (cons_384 x_125539 x_125540) (cons_384 x_125541 x_125542)))))
...
(assert (forall ((x_125621 T_37) (x_125622 T_37))
	(=> (diseqT_33 x_125621 x_125622)
	    (diseqR_47 (Atom_47 x_125621) (Atom_47 x_125622)))))
(assert (forall ((x_125623 R_644) (x_125624 R_644) (x_125625 R_644) (x_125626 R_644))
	(=> (diseqR_47 x_125623 x_125625)
	    (diseqR_47 (x_125480 x_125623 x_125624) (x_125480 x_125625 x_125626)))))
(assert (forall ((x_125623 R_644) (x_125624 R_644) (x_125625 R_644) (x_125626 R_644))
	(=> (diseqR_47 x_125624 x_125626)
	    (diseqR_47 (x_125480 x_125623 x_125624) (x_125480 x_125625 x_125626)))))
(assert (forall ((x_125627 R_644) (x_125628 R_644) (x_125629 R_644) (x_125630 R_644))
	(=> (diseqR_47 x_125627 x_125629)
	    (diseqR_47 (x_125481 x_125627 x_125628) (x_125481 x_125629 x_125630)))))
(assert (forall ((x_125627 R_644) (x_125628 R_644) (x_125629 R_644) (x_125630 R_644))
	(=> (diseqR_47 x_125628 x_125630)
	    (diseqR_47 (x_125481 x_125627 x_125628) (x_125481 x_125629 x_125630)))))
(assert (forall ((x_125631 R_644) (x_125632 R_644))
	(=> (diseqR_47 x_125631 x_125632)
	    (diseqR_47 (Star_47 x_125631) (Star_47 x_125632)))))
...
(assert (forall ((x_125489 Bool_435) (x_125490 Bool_435) (x_125491 Bool_435) (r_645 R_644) (q_361 R_644))
	(=>	(and (eps_95 x_125490 r_645)
			(eps_95 x_125491 q_361)
			(and_441 x_125489 x_125490 x_125491))
		(eps_95 x_125489 (x_125481 r_645 q_361)))))
(assert (forall ((x_125492 Bool_435) (x_125493 Bool_435) (x_125494 Bool_435) (p_593 R_644) (q_362 R_644))
	(=>	(and (eps_95 x_125493 p_593)
			(eps_95 x_125494 q_362)
			(or_454 x_125492 x_125493 x_125494))
		(eps_95 x_125492 (x_125480 p_593 q_362)))))
...
(assert (forall ((x_125499 R_644) (p_594 R_644) (y_3173 T_37))
	(=> (step_47 x_125499 p_594 y_3173)
	    (step_47 (x_125481 x_125499 (Star_47 p_594)) (Star_47 p_594) y_3173))))
(assert (forall ((x_125502 R_644) (x_125503 R_644) (r_646 R_644) (q_363 R_644) (y_3173 T_37))
	(=>	(and (step_47 x_125502 r_646 y_3173)
			(step_47 x_125503 q_363 y_3173)
			(eps_95 true_435 r_646))
		(step_47 (x_125480 (x_125481 x_125502 q_363) x_125503) (x_125481 r_646 q_363) y_3173))))
(assert (forall ((x_125506 R_644) (r_646 R_644) (q_363 R_644) (y_3173 T_37))
	(=>	(and (step_47 x_125506 r_646 y_3173)
			(eps_95 false_435 r_646))
		(step_47 (x_125480 (x_125481 x_125506 q_363) Nil_448) (x_125481 r_646 q_363) y_3173))))
(assert (forall ((x_125508 R_644) (x_125509 R_644) (p_595 R_644) (q_364 R_644) (y_3173 T_37))
	(=>	(and (step_47 x_125508 p_595 y_3173)
			(step_47 x_125509 q_364 y_3173))
		(step_47 (x_125480 x_125508 x_125509) (x_125480 p_595 q_364) y_3173))))
(assert (forall ((b_133 T_37))
	(step_47 Eps_94 (Atom_47 b_133) b_133)))
(assert (forall ((b_133 T_37) (y_3173 T_37))
	(=> (diseqT_33 b_133 y_3173)
	    (step_47 Nil_448 (Atom_47 b_133) y_3173))))
...
(assert (forall ((x_125514 Bool_435) (x_125515 R_644) (z_2713 T_37) (xs_882 list_390) (x_125486 R_644))
	(=>	(and (step_47 x_125515 x_125486 z_2713)
			(rec_33 x_125514 x_125515 xs_882))
		(rec_33 x_125514 x_125486 (cons_384 z_2713 xs_882)))))
(assert (forall ((x_125517 Bool_435) (x_125486 R_644))
	(=> (eps_95 x_125517 x_125486)
	    (rec_33 x_125517 x_125486 nil_447))))
(assert (forall ((p_596 R_644) (q_365 R_644) (a_120 T_37) (b_134 T_37))
	(=>	(and true
			(rec_33 true_435 (Star_47 (x_125480 p_596 q_365)) (cons_384 a_120 (cons_384 b_134 nil_447)))
			(rec_33 false_435 (x_125480 (Star_47 p_596) (Star_47 q_365)) (cons_384 a_120 (cons_384 b_134 nil_447))))
		false)))
(check-sat)
