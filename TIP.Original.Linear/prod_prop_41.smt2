...
(declare-datatypes ((Nat_597 0)) (((Z_2101 ) (S_486 (projS_202 Nat_597)))))
(declare-fun diseqNat_597 (Nat_597 Nat_597) Bool)
(declare-fun projS_203 (Nat_597 Nat_597) Bool)
(declare-fun isZ_453 (Nat_597) Bool)
(declare-fun isS_453 (Nat_597) Bool)
(assert (forall ((x_55862 Nat_597))
	(projS_203 x_55862 (S_486 x_55862))))
(assert (isZ_453 Z_2101))
(assert (forall ((x_55864 Nat_597))
	(isS_453 (S_486 x_55864))))
(assert (forall ((x_55865 Nat_597))
	(diseqNat_597 Z_2101 (S_486 x_55865))))
(assert (forall ((x_55866 Nat_597))
	(diseqNat_597 (S_486 x_55866) Z_2101)))
(assert (forall ((x_55867 Nat_597) (x_55868 Nat_597))
	(=> (diseqNat_597 x_55867 x_55868)
	    (diseqNat_597 (S_486 x_55867) (S_486 x_55868)))))
(declare-datatypes ((list_253 0)) (((nil_283 ) (cons_253 (head_506 Nat_597) (tail_506 list_253)))))
(declare-fun diseqlist_253 (list_253 list_253) Bool)
(declare-fun head_507 (Nat_597 list_253) Bool)
(declare-fun tail_507 (list_253 list_253) Bool)
(declare-fun isnil_283 (list_253) Bool)
(declare-fun iscons_253 (list_253) Bool)
(assert (forall ((x_55870 Nat_597) (x_55871 list_253))
	(head_507 x_55870 (cons_253 x_55870 x_55871))))
(assert (forall ((x_55870 Nat_597) (x_55871 list_253))
	(tail_507 x_55871 (cons_253 x_55870 x_55871))))
(assert (isnil_283 nil_283))
(assert (forall ((x_55873 Nat_597) (x_55874 list_253))
	(iscons_253 (cons_253 x_55873 x_55874))))
(assert (forall ((x_55875 Nat_597) (x_55876 list_253))
	(diseqlist_253 nil_283 (cons_253 x_55875 x_55876))))
(assert (forall ((x_55877 Nat_597) (x_55878 list_253))
	(diseqlist_253 (cons_253 x_55877 x_55878) nil_283)))
(assert (forall ((x_55879 Nat_597) (x_55880 list_253) (x_55881 Nat_597) (x_55882 list_253))
	(=> (diseqNat_597 x_55879 x_55881)
	    (diseqlist_253 (cons_253 x_55879 x_55880) (cons_253 x_55881 x_55882)))))
(assert (forall ((x_55879 Nat_597) (x_55880 list_253) (x_55881 Nat_597) (x_55882 list_253))
	(=> (diseqlist_253 x_55880 x_55882)
	    (diseqlist_253 (cons_253 x_55879 x_55880) (cons_253 x_55881 x_55882)))))
...
(declare-fun x_55821 (Bool_352 Nat_597 Nat_597) Bool)
(assert (forall ((x_55832 Bool_352) (y_2337 Nat_597) (x_55823 Nat_597))
	(=> (x_55821 x_55832 x_55823 y_2337)
	    (x_55821 x_55832 (S_486 x_55823) (S_486 y_2337)))))
(assert (forall ((x_55823 Nat_597))
	(x_55821 false_352 (S_486 x_55823) Z_2101)))
(assert (forall ((z_2102 Nat_597))
	(x_55821 false_352 Z_2101 (S_486 z_2102))))
(assert (x_55821 true_352 Z_2101 Z_2101))
(declare-fun elem_21 (Bool_352 Nat_597 list_253) Bool)
(assert (forall ((x_55837 Bool_352) (x_55838 Bool_352) (x_55839 Bool_352) (z_2103 Nat_597) (xs_676 list_253) (x_55824 Nat_597))
	(=>	(and (x_55821 x_55838 x_55824 z_2103)
			(elem_21 x_55839 x_55824 xs_676)
			(barbar_9 x_55837 x_55838 x_55839))
		(elem_21 x_55837 x_55824 (cons_253 z_2103 xs_676)))))
(assert (forall ((x_55824 Nat_597))
	(elem_21 false_352 x_55824 nil_283)))
(declare-fun intersect_1 (list_253 list_253 list_253) Bool)
(assert (forall ((x_55844 list_253) (z_2104 Nat_597) (xs_677 list_253) (y_2339 list_253))
	(=>	(and (intersect_1 x_55844 xs_677 y_2339)
			(elem_21 true_352 z_2104 y_2339))
		(intersect_1 (cons_253 z_2104 x_55844) (cons_253 z_2104 xs_677) y_2339))))
(assert (forall ((x_55846 list_253) (z_2104 Nat_597) (xs_677 list_253) (y_2339 list_253))
	(=>	(and (intersect_1 x_55846 xs_677 y_2339)
			(elem_21 false_352 z_2104 y_2339))
		(intersect_1 x_55846 (cons_253 z_2104 xs_677) y_2339))))
...
(assert (forall ((x_55851 Bool_352) (x_55852 Bool_352) (x_55853 Bool_352) (z_2105 Nat_597) (xs_678 list_253) (y_2341 list_253))
	(=>	(and (elem_21 x_55852 z_2105 y_2341)
			(subset_1 x_55853 xs_678 y_2341)
			(x_55826 x_55851 x_55852 x_55853))
		(subset_1 x_55851 (cons_253 z_2105 xs_678) y_2341))))
...
(assert (forall ((x_55856 list_253) (x_55829 list_253) (y_2342 list_253))
	(=>	(and true
			(diseqlist_253 x_55856 x_55829)
			(subset_1 true_352 x_55829 y_2342)
			(intersect_1 x_55856 x_55829 y_2342))
		false)))
(check-sat)
