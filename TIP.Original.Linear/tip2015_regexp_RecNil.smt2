...
(assert (forall ((x_14896 A_20) (x_14897 A_20))
	(=> (diseqA_3 x_14896 x_14897)
	    (diseqR_3 (Atom_3 x_14896) (Atom_3 x_14897)))))
(assert (forall ((x_14898 R_126) (x_14899 R_126) (x_14900 R_126) (x_14901 R_126))
	(=> (diseqR_3 x_14898 x_14900)
	    (diseqR_3 (Plus_19 x_14898 x_14899) (Plus_19 x_14900 x_14901)))))
(assert (forall ((x_14898 R_126) (x_14899 R_126) (x_14900 R_126) (x_14901 R_126))
	(=> (diseqR_3 x_14899 x_14901)
	    (diseqR_3 (Plus_19 x_14898 x_14899) (Plus_19 x_14900 x_14901)))))
(assert (forall ((x_14902 R_126) (x_14903 R_126) (x_14904 R_126) (x_14905 R_126))
	(=> (diseqR_3 x_14902 x_14904)
	    (diseqR_3 (Seq_6 x_14902 x_14903) (Seq_6 x_14904 x_14905)))))
(assert (forall ((x_14902 R_126) (x_14903 R_126) (x_14904 R_126) (x_14905 R_126))
	(=> (diseqR_3 x_14903 x_14905)
	    (diseqR_3 (Seq_6 x_14902 x_14903) (Seq_6 x_14904 x_14905)))))
(assert (forall ((x_14906 R_126) (x_14907 R_126))
	(=> (diseqR_3 x_14906 x_14907)
	    (diseqR_3 (Star_3 x_14906) (Star_3 x_14907)))))
...
(assert (forall ((x_14918 A_20) (x_14919 list_84) (x_14920 A_20) (x_14921 list_84))
	(=> (diseqA_3 x_14918 x_14920)
	    (diseqlist_84 (cons_84 x_14918 x_14919) (cons_84 x_14920 x_14921)))))
(assert (forall ((x_14918 A_20) (x_14919 list_84) (x_14920 A_20) (x_14921 list_84))
	(=> (diseqlist_84 x_14919 x_14921)
	    (diseqlist_84 (cons_84 x_14918 x_14919) (cons_84 x_14920 x_14921)))))
...
(assert (forall ((x_14772 Bool_112) (x_14773 Bool_112) (x_14774 Bool_112) (r_127 R_126) (q_19 R_126))
	(=>	(and (eps_7 x_14773 r_127)
			(eps_7 x_14774 q_19)
			(and_112 x_14772 x_14773 x_14774))
		(eps_7 x_14772 (Seq_6 r_127 q_19)))))
(assert (forall ((x_14775 Bool_112) (x_14776 Bool_112) (x_14777 Bool_112) (p_58 R_126) (q_20 R_126))
	(=>	(and (eps_7 x_14776 p_58)
			(eps_7 x_14777 q_20)
			(or_113 x_14775 x_14776 x_14777))
		(eps_7 x_14775 (Plus_19 p_58 q_20)))))
...
(assert (forall ((x_12744 R_126))
	(=> (eps_7 true_112 x_12744)
	    (epsR_3 Eps_6 x_12744))))
(assert (forall ((x_12744 R_126))
	(=> (eps_7 false_112 x_12744)
	    (epsR_3 Nil_89 x_12744))))
(declare-fun step_3 (R_126 R_126 A_20) Bool)
(assert (forall ((x_14785 R_126) (x_14786 R_126) (p_59 R_126) (y_571 A_20))
	(=>	(and (step_3 x_14786 p_59 y_571)
			(seq_7 x_14785 x_14786 (Star_3 p_59)))
		(step_3 x_14785 (Star_3 p_59) y_571))))
(assert (forall ((x_14788 R_126) (x_14789 R_126) (x_14790 R_126) (x_14791 R_126) (x_14792 R_126) (x_14793 R_126) (r_128 R_126) (q_21 R_126) (y_571 A_20))
	(=>	(and (step_3 x_14789 r_128 y_571)
			(seq_7 x_14790 x_14789 q_21)
			(epsR_3 x_14791 r_128)
			(step_3 x_14792 q_21 y_571)
			(seq_7 x_14793 x_14791 x_14792)
			(plus_20 x_14788 x_14790 x_14793))
		(step_3 x_14788 (Seq_6 r_128 q_21) y_571))))
(assert (forall ((x_14795 R_126) (x_14796 R_126) (x_14797 R_126) (p_60 R_126) (q_22 R_126) (y_571 A_20))
	(=>	(and (step_3 x_14796 p_60 y_571)
			(step_3 x_14797 q_22 y_571)
			(plus_20 x_14795 x_14796 x_14797))
		(step_3 x_14795 (Plus_19 p_60 q_22) y_571))))
(assert (forall ((a_21 A_20) (y_571 A_20))
	(=> (eqA_3 true_112 a_21 y_571)
	    (step_3 Eps_6 (Atom_3 a_21) y_571))))
(assert (forall ((a_21 A_20) (y_571 A_20))
	(=> (eqA_3 false_112 a_21 y_571)
	    (step_3 Nil_89 (Atom_3 a_21) y_571))))
...
(assert (forall ((x_14805 Bool_112) (x_14806 R_126) (z_616 A_20) (xs_184 list_84) (x_12747 R_126))
	(=>	(and (step_3 x_14806 x_12747 z_616)
			(recognise_3 x_14805 x_14806 xs_184))
		(recognise_3 x_14805 x_12747 (cons_84 z_616 xs_184)))))
(assert (forall ((x_14808 Bool_112) (x_12747 R_126))
	(=> (eps_7 x_14808 x_12747)
	    (recognise_3 x_14808 x_12747 nil_90))))
(assert (forall ((s_192 list_84))
	(=>	(and true
			(recognise_3 true_112 Nil_89 s_192))
		false)))
(check-sat)
