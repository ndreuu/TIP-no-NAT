...
(assert (forall ((x_126360 T_40) (x_126361 list_401) (x_126362 T_40) (x_126363 list_401))
	(=> (diseqT_36 x_126360 x_126362)
	    (diseqlist_395 (cons_395 x_126360 x_126361) (cons_395 x_126362 x_126363)))))
(assert (forall ((x_126360 T_40) (x_126361 list_401) (x_126362 T_40) (x_126363 list_401))
	(=> (diseqlist_395 x_126361 x_126363)
	    (diseqlist_395 (cons_395 x_126360 x_126361) (cons_395 x_126362 x_126363)))))
...
(assert (forall ((x_126442 T_40) (x_126443 T_40))
	(=> (diseqT_36 x_126442 x_126443)
	    (diseqR_50 (Atom_50 x_126442) (Atom_50 x_126443)))))
(assert (forall ((x_126444 R_664) (x_126445 R_664) (x_126446 R_664) (x_126447 R_664))
	(=> (diseqR_50 x_126444 x_126446)
	    (diseqR_50 (x_126302 x_126444 x_126445) (x_126302 x_126446 x_126447)))))
(assert (forall ((x_126444 R_664) (x_126445 R_664) (x_126446 R_664) (x_126447 R_664))
	(=> (diseqR_50 x_126445 x_126447)
	    (diseqR_50 (x_126302 x_126444 x_126445) (x_126302 x_126446 x_126447)))))
(assert (forall ((x_126448 R_664) (x_126449 R_664) (x_126450 R_664) (x_126451 R_664))
	(=> (diseqR_50 x_126448 x_126450)
	    (diseqR_50 (x_126303 x_126448 x_126449) (x_126303 x_126450 x_126451)))))
(assert (forall ((x_126448 R_664) (x_126449 R_664) (x_126450 R_664) (x_126451 R_664))
	(=> (diseqR_50 x_126449 x_126451)
	    (diseqR_50 (x_126303 x_126448 x_126449) (x_126303 x_126450 x_126451)))))
(assert (forall ((x_126452 R_664) (x_126453 R_664))
	(=> (diseqR_50 x_126452 x_126453)
	    (diseqR_50 (Star_50 x_126452) (Star_50 x_126453)))))
...
(assert (forall ((x_126311 Bool_442) (x_126312 Bool_442) (x_126313 Bool_442) (r_665 R_664) (q_380 R_664))
	(=>	(and (eps_101 x_126312 r_665)
			(eps_101 x_126313 q_380)
			(and_448 x_126311 x_126312 x_126313))
		(eps_101 x_126311 (x_126303 r_665 q_380)))))
(assert (forall ((x_126314 Bool_442) (x_126315 Bool_442) (x_126316 Bool_442) (p_611 R_664) (q_381 R_664))
	(=>	(and (eps_101 x_126315 p_611)
			(eps_101 x_126316 q_381)
			(or_463 x_126314 x_126315 x_126316))
		(eps_101 x_126314 (x_126302 p_611 q_381)))))
...
(assert (forall ((x_126321 R_664) (p_612 R_664) (y_3206 T_40))
	(=> (step_50 x_126321 p_612 y_3206)
	    (step_50 (x_126303 x_126321 (Star_50 p_612)) (Star_50 p_612) y_3206))))
(assert (forall ((x_126324 R_664) (x_126325 R_664) (r_666 R_664) (q_382 R_664) (y_3206 T_40))
	(=>	(and (step_50 x_126324 r_666 y_3206)
			(step_50 x_126325 q_382 y_3206)
			(eps_101 true_442 r_666))
		(step_50 (x_126302 (x_126303 x_126324 q_382) x_126325) (x_126303 r_666 q_382) y_3206))))
(assert (forall ((x_126328 R_664) (r_666 R_664) (q_382 R_664) (y_3206 T_40))
	(=>	(and (step_50 x_126328 r_666 y_3206)
			(eps_101 false_442 r_666))
		(step_50 (x_126302 (x_126303 x_126328 q_382) Nil_462) (x_126303 r_666 q_382) y_3206))))
(assert (forall ((x_126330 R_664) (x_126331 R_664) (p_613 R_664) (q_383 R_664) (y_3206 T_40))
	(=>	(and (step_50 x_126330 p_613 y_3206)
			(step_50 x_126331 q_383 y_3206))
		(step_50 (x_126302 x_126330 x_126331) (x_126302 p_613 q_383) y_3206))))
(assert (forall ((b_142 T_40))
	(step_50 Eps_100 (Atom_50 b_142) b_142)))
(assert (forall ((b_142 T_40) (y_3206 T_40))
	(=> (diseqT_36 b_142 y_3206)
	    (step_50 Nil_462 (Atom_50 b_142) y_3206))))
...
(assert (forall ((x_126336 Bool_442) (x_126337 R_664) (z_2744 T_40) (xs_897 list_401) (x_126308 R_664))
	(=>	(and (step_50 x_126337 x_126308 z_2744)
			(rec_36 x_126336 x_126337 xs_897))
		(rec_36 x_126336 x_126308 (cons_395 z_2744 xs_897)))))
(assert (forall ((x_126339 Bool_442) (x_126308 R_664))
	(=> (eps_101 x_126339 x_126308)
	    (rec_36 x_126339 x_126308 nil_461))))
(assert (forall ((p_614 R_664))
	(=>	(and true
			(rec_36 true_442 p_614 (cons_395 A_123 (cons_395 A_123 (cons_395 B_141 (cons_395 B_141 nil_461))))))
		false)))
(check-sat)
