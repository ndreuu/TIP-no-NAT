...
(assert (forall ((x_60357 T_6) (x_60358 list_306) (x_60359 T_6) (x_60360 list_306))
	(=> (diseqT_6 x_60357 x_60359)
	    (diseqlist_303 (cons_303 x_60357 x_60358) (cons_303 x_60359 x_60360)))))
(assert (forall ((x_60357 T_6) (x_60358 list_306) (x_60359 T_6) (x_60360 list_306))
	(=> (diseqlist_303 x_60358 x_60360)
	    (diseqlist_303 (cons_303 x_60357 x_60358) (cons_303 x_60359 x_60360)))))
...
(assert (forall ((x_60439 T_6) (x_60440 T_6))
	(=> (diseqT_6 x_60439 x_60440)
	    (diseqR_20 (Atom_20 x_60439) (Atom_20 x_60440)))))
(assert (forall ((x_60441 R_486) (x_60442 R_486) (x_60443 R_486) (x_60444 R_486))
	(=> (diseqR_20 x_60441 x_60443)
	    (diseqR_20 (x_60299 x_60441 x_60442) (x_60299 x_60443 x_60444)))))
(assert (forall ((x_60441 R_486) (x_60442 R_486) (x_60443 R_486) (x_60444 R_486))
	(=> (diseqR_20 x_60442 x_60444)
	    (diseqR_20 (x_60299 x_60441 x_60442) (x_60299 x_60443 x_60444)))))
(assert (forall ((x_60445 R_486) (x_60446 R_486) (x_60447 R_486) (x_60448 R_486))
	(=> (diseqR_20 x_60445 x_60447)
	    (diseqR_20 (x_60300 x_60445 x_60446) (x_60300 x_60447 x_60448)))))
(assert (forall ((x_60445 R_486) (x_60446 R_486) (x_60447 R_486) (x_60448 R_486))
	(=> (diseqR_20 x_60446 x_60448)
	    (diseqR_20 (x_60300 x_60445 x_60446) (x_60300 x_60447 x_60448)))))
(assert (forall ((x_60449 R_486) (x_60450 R_486))
	(=> (diseqR_20 x_60449 x_60450)
	    (diseqR_20 (Star_20 x_60449) (Star_20 x_60450)))))
...
(assert (forall ((x_60308 Bool_386) (x_60309 Bool_386) (x_60310 Bool_386) (r_487 R_486) (q_175 R_486))
	(=>	(and (eps_41 x_60309 r_487)
			(eps_41 x_60310 q_175)
			(and_387 x_60308 x_60309 x_60310))
		(eps_41 x_60308 (x_60300 r_487 q_175)))))
(assert (forall ((x_60311 Bool_386) (x_60312 Bool_386) (x_60313 Bool_386) (p_439 R_486) (q_176 R_486))
	(=>	(and (eps_41 x_60312 p_439)
			(eps_41 x_60313 q_176)
			(or_399 x_60311 x_60312 x_60313))
		(eps_41 x_60311 (x_60299 p_439 q_176)))))
...
(assert (forall ((x_60318 R_486) (p_440 R_486) (y_2613 T_6))
	(=> (step_20 x_60318 p_440 y_2613)
	    (step_20 (x_60300 x_60318 (Star_20 p_440)) (Star_20 p_440) y_2613))))
(assert (forall ((x_60321 R_486) (x_60322 R_486) (r_488 R_486) (q_177 R_486) (y_2613 T_6))
	(=>	(and (step_20 x_60321 r_488 y_2613)
			(step_20 x_60322 q_177 y_2613)
			(eps_41 true_386 r_488))
		(step_20 (x_60299 (x_60300 x_60321 q_177) x_60322) (x_60300 r_488 q_177) y_2613))))
(assert (forall ((x_60325 R_486) (r_488 R_486) (q_177 R_486) (y_2613 T_6))
	(=>	(and (step_20 x_60325 r_488 y_2613)
			(eps_41 false_386 r_488))
		(step_20 (x_60299 (x_60300 x_60325 q_177) Nil_340) (x_60300 r_488 q_177) y_2613))))
(assert (forall ((x_60327 R_486) (x_60328 R_486) (p_441 R_486) (q_178 R_486) (y_2613 T_6))
	(=>	(and (step_20 x_60327 p_441 y_2613)
			(step_20 x_60328 q_178 y_2613))
		(step_20 (x_60299 x_60327 x_60328) (x_60299 p_441 q_178) y_2613))))
(assert (forall ((b_59 T_6))
	(step_20 Eps_40 (Atom_20 b_59) b_59)))
(assert (forall ((b_59 T_6) (y_2613 T_6))
	(=> (diseqT_6 b_59 y_2613)
	    (step_20 Nil_340 (Atom_20 b_59) y_2613))))
...
(assert (forall ((x_60333 Bool_386) (x_60334 R_486) (z_2335 T_6) (xs_773 list_306) (x_60305 R_486))
	(=>	(and (step_20 x_60334 x_60305 z_2335)
			(rec_6 x_60333 x_60334 xs_773))
		(rec_6 x_60333 x_60305 (cons_303 z_2335 xs_773)))))
(assert (forall ((x_60336 Bool_386) (x_60305 R_486))
	(=> (eps_41 x_60336 x_60305)
	    (rec_6 x_60336 x_60305 nil_339))))
(assert (forall ((p_442 R_486))
	(=>	(and true
			(rec_6 true_386 p_442 (cons_303 A_68 (cons_303 B_58 (cons_303 B_58 (cons_303 A_68 nil_339))))))
		false)))
(check-sat)
