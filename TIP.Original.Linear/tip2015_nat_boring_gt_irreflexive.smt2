...
(declare-datatypes ((Nat_168 0)) (((zero_7 ) (succ_7 (p_14 Nat_168)))))
(declare-fun diseqNat_168 (Nat_168 Nat_168) Bool)
(declare-fun p_15 (Nat_168 Nat_168) Bool)
(declare-fun iszero_7 (Nat_168) Bool)
(declare-fun issucc_7 (Nat_168) Bool)
(assert (forall ((x_4656 Nat_168))
	(p_15 x_4656 (succ_7 x_4656))))
(assert (iszero_7 zero_7))
(assert (forall ((x_4658 Nat_168))
	(issucc_7 (succ_7 x_4658))))
(assert (forall ((x_4659 Nat_168))
	(diseqNat_168 zero_7 (succ_7 x_4659))))
(assert (forall ((x_4660 Nat_168))
	(diseqNat_168 (succ_7 x_4660) zero_7)))
(assert (forall ((x_4661 Nat_168) (x_4662 Nat_168))
	(=> (diseqNat_168 x_4661 x_4662)
	    (diseqNat_168 (succ_7 x_4661) (succ_7 x_4662)))))
(declare-fun lt_88 (Bool_88 Nat_168 Nat_168) Bool)
(assert (forall ((x_4645 Bool_88) (n_33 Nat_168) (z_471 Nat_168))
	(=> (lt_88 x_4645 n_33 z_471)
	    (lt_88 x_4645 (succ_7 n_33) (succ_7 z_471)))))
(assert (forall ((z_471 Nat_168))
	(lt_88 true_88 zero_7 (succ_7 z_471))))
(assert (forall ((x_4642 Nat_168))
	(lt_88 false_88 x_4642 zero_7)))
(declare-fun gt_88 (Bool_88 Nat_168 Nat_168) Bool)
(assert (forall ((x_4649 Bool_88) (x_4643 Nat_168) (y_387 Nat_168))
	(=> (lt_88 x_4649 y_387 x_4643)
	    (gt_88 x_4649 x_4643 y_387))))
(assert (forall ((x_4644 Nat_168))
	(=>	(and true
			(gt_88 true_88 x_4644 x_4644))
		false)))
(check-sat)
