...
(assert (forall ((x_124962 Bool_433) (x_124963 list_381) (x_124964 Bool_433) (x_124965 list_381))
	(=> (diseqBool_216 x_124962 x_124964)
	    (diseqlist_375 (cons_375 x_124962 x_124963) (cons_375 x_124964 x_124965)))))
(assert (forall ((x_124962 Bool_433) (x_124963 list_381) (x_124964 Bool_433) (x_124965 list_381))
	(=> (diseqlist_375 x_124963 x_124965)
	    (diseqlist_375 (cons_375 x_124962 x_124963) (cons_375 x_124964 x_124965)))))
...
(assert (forall ((x_124979 T_36) (x_124980 list_382) (x_124981 T_36) (x_124982 list_382))
	(=> (diseqT_32 x_124979 x_124981)
	    (diseqlist_376 (cons_376 x_124979 x_124980) (cons_376 x_124981 x_124982)))))
(assert (forall ((x_124979 T_36) (x_124980 list_382) (x_124981 T_36) (x_124982 list_382))
	(=> (diseqlist_376 x_124980 x_124982)
	    (diseqlist_376 (cons_376 x_124979 x_124980) (cons_376 x_124981 x_124982)))))
...
(assert (forall ((x_124988 list_382) (x_124989 list_382) (x_124990 list_382) (x_124991 list_382))
	(=> (diseqlist_376 x_124988 x_124990)
	    (diseqpair_98 (pair_197 x_124988 x_124989) (pair_197 x_124990 x_124991)))))
(assert (forall ((x_124988 list_382) (x_124989 list_382) (x_124990 list_382) (x_124991 list_382))
	(=> (diseqlist_376 x_124989 x_124991)
	    (diseqpair_98 (pair_197 x_124988 x_124989) (pair_197 x_124990 x_124991)))))
...
(assert (forall ((x_125002 pair_196) (x_125003 list_383) (x_125004 pair_196) (x_125005 list_383))
	(=> (diseqpair_98 x_125002 x_125004)
	    (diseqlist_377 (cons_377 x_125002 x_125003) (cons_377 x_125004 x_125005)))))
(assert (forall ((x_125002 pair_196) (x_125003 list_383) (x_125004 pair_196) (x_125005 list_383))
	(=> (diseqlist_377 x_125003 x_125005)
	    (diseqlist_377 (cons_377 x_125002 x_125003) (cons_377 x_125004 x_125005)))))
...
(assert (forall ((x_125084 T_36) (x_125085 T_36))
	(=> (diseqT_32 x_125084 x_125085)
	    (diseqR_46 (Atom_46 x_125084) (Atom_46 x_125085)))))
(assert (forall ((x_125086 R_637) (x_125087 R_637) (x_125088 R_637) (x_125089 R_637))
	(=> (diseqR_46 x_125086 x_125088)
	    (diseqR_46 (x_124857 x_125086 x_125087) (x_124857 x_125088 x_125089)))))
(assert (forall ((x_125086 R_637) (x_125087 R_637) (x_125088 R_637) (x_125089 R_637))
	(=> (diseqR_46 x_125087 x_125089)
	    (diseqR_46 (x_124857 x_125086 x_125087) (x_124857 x_125088 x_125089)))))
(assert (forall ((x_125090 R_637) (x_125091 R_637) (x_125092 R_637) (x_125093 R_637))
	(=> (diseqR_46 x_125090 x_125092)
	    (diseqR_46 (x_124858 x_125090 x_125091) (x_124858 x_125092 x_125093)))))
(assert (forall ((x_125090 R_637) (x_125091 R_637) (x_125092 R_637) (x_125093 R_637))
	(=> (diseqR_46 x_125091 x_125093)
	    (diseqR_46 (x_124858 x_125090 x_125091) (x_124858 x_125092 x_125093)))))
(assert (forall ((x_125094 R_637) (x_125095 R_637))
	(=> (diseqR_46 x_125094 x_125095)
	    (diseqR_46 (Star_46 x_125094) (Star_46 x_125095)))))
...
(assert (forall ((x_124878 list_383) (bs_21 list_382) (cs_7 list_382) (x_124860 list_383) (x_124859 T_36))
	(=> (splits_10 x_124878 x_124859 x_124860)
	    (splits_10 (cons_377 (pair_197 (cons_376 x_124859 bs_21) cs_7) x_124878) x_124859 (cons_377 (pair_197 bs_21 cs_7) x_124860)))))
...
(assert (forall ((x_124881 list_383) (x_124882 list_383) (y_3140 T_36) (xs_874 list_382))
	(=>	(and (splits_11 x_124881 xs_874)
			(splits_10 x_124882 y_3140 x_124881))
		(splits_11 (cons_377 (pair_197 nil_438 (cons_376 y_3140 xs_874)) x_124882) (cons_376 y_3140 xs_874)))))
...
(assert (forall ((x_124884 Bool_433) (x_124885 Bool_433) (y_3141 Bool_433) (xs_875 list_381))
	(=>	(and (or_450 x_124885 xs_875)
			(or_451 x_124884 y_3141 x_124885))
		(or_450 x_124884 (cons_375 y_3141 xs_875)))))
...
(assert (forall ((x_124888 Bool_433) (x_124889 Bool_433) (x_124890 Bool_433) (r_638 R_637) (q_354 R_637))
	(=>	(and (eps_93 x_124889 r_638)
			(eps_93 x_124890 q_354)
			(and_439 x_124888 x_124889 x_124890))
		(eps_93 x_124888 (x_124858 r_638 q_354)))))
(assert (forall ((x_124891 Bool_433) (x_124892 Bool_433) (x_124893 Bool_433) (p_585 R_637) (q_355 R_637))
	(=>	(and (eps_93 x_124892 p_585)
			(eps_93 x_124893 q_355)
			(or_451 x_124891 x_124892 x_124893))
		(eps_93 x_124891 (x_124857 p_585 q_355)))))
...
(assert (forall ((x_124898 R_637) (p_586 R_637) (y_3143 T_36))
	(=> (step_46 x_124898 p_586 y_3143)
	    (step_46 (x_124858 x_124898 (Star_46 p_586)) (Star_46 p_586) y_3143))))
(assert (forall ((x_124901 R_637) (x_124902 R_637) (r_639 R_637) (q_356 R_637) (y_3143 T_36))
	(=>	(and (step_46 x_124901 r_639 y_3143)
			(step_46 x_124902 q_356 y_3143)
			(eps_93 true_433 r_639))
		(step_46 (x_124857 (x_124858 x_124901 q_356) x_124902) (x_124858 r_639 q_356) y_3143))))
(assert (forall ((x_124905 R_637) (r_639 R_637) (q_356 R_637) (y_3143 T_36))
	(=>	(and (step_46 x_124905 r_639 y_3143)
			(eps_93 false_433 r_639))
		(step_46 (x_124857 (x_124858 x_124905 q_356) Nil_440) (x_124858 r_639 q_356) y_3143))))
(assert (forall ((x_124907 R_637) (x_124908 R_637) (p_587 R_637) (q_357 R_637) (y_3143 T_36))
	(=>	(and (step_46 x_124907 p_587 y_3143)
			(step_46 x_124908 q_357 y_3143))
		(step_46 (x_124857 x_124907 x_124908) (x_124857 p_587 q_357) y_3143))))
(assert (forall ((b_129 T_36))
	(step_46 Eps_92 (Atom_46 b_129) b_129)))
(assert (forall ((b_129 T_36) (y_3143 T_36))
	(=> (diseqT_32 b_129 y_3143)
	    (step_46 Nil_440 (Atom_46 b_129) y_3143))))
...
(assert (forall ((x_124913 Bool_433) (x_124914 R_637) (z_2690 T_36) (xs_876 list_382) (x_124867 R_637))
	(=>	(and (step_46 x_124914 x_124867 z_2690)
			(rec_32 x_124913 x_124914 xs_876))
		(rec_32 x_124913 x_124867 (cons_376 z_2690 xs_876)))))
(assert (forall ((x_124916 Bool_433) (x_124867 R_637))
	(=> (eps_93 x_124916 x_124867)
	    (rec_32 x_124916 x_124867 nil_438))))
...
(assert (forall ((x_124919 Bool_433) (x_124869 T_36) (x_124870 list_382) (p_588 R_637))
	(=>	(and (rec_32 x_124919 (x_124858 p_588 (Star_46 p_588)) (cons_376 x_124869 x_124870))
			(eps_93 false_433 p_588))
		(reck_10 x_124919 (Star_46 p_588) (cons_376 x_124869 x_124870)))))
(assert (forall ((x_124869 T_36) (x_124870 list_382) (p_588 R_637))
	(=> (eps_93 true_433 p_588)
	    (reck_10 false_433 (Star_46 p_588) (cons_376 x_124869 x_124870)))))
...
(assert (forall ((x_124924 Bool_433) (x_124925 list_383) (x_124926 list_381) (r_640 R_637) (q_358 R_637) (y_3145 list_382))
	(=>	(and (splits_11 x_124925 y_3145)
			(reck_11 x_124926 r_640 q_358 x_124925)
			(or_450 x_124924 x_124926))
		(reck_10 x_124924 (x_124858 r_640 q_358) y_3145))))
(assert (forall ((x_124928 Bool_433) (x_124929 Bool_433) (x_124930 Bool_433) (p_589 R_637) (q_359 R_637) (y_3145 list_382))
	(=>	(and (reck_10 x_124929 p_589 y_3145)
			(reck_10 x_124930 q_359 y_3145)
			(or_451 x_124928 x_124929 x_124930))
		(reck_10 x_124928 (x_124857 p_589 q_359) y_3145))))
...
(assert (forall ((b_130 T_36) (c_73 T_36))
	(=> (diseqT_32 c_73 b_130)
	    (reck_10 false_433 (Atom_46 c_73) (cons_376 b_130 nil_438)))))
...
(assert (forall ((x_124948 Bool_433) (x_124939 Bool_433) (x_124940 Bool_433) (x_124941 list_381) (l_59 list_382) (r_641 list_382) (z_2692 list_383) (p_590 R_637) (q_360 R_637))
	(=>	(and (reck_10 x_124939 p_590 l_59)
			(rec_32 x_124940 q_360 r_641)
			(reck_11 x_124941 p_590 q_360 z_2692)
			(and_439 x_124948 x_124939 x_124940))
		(reck_11 (cons_375 x_124948 x_124941) p_590 q_360 (cons_377 (pair_197 l_59 r_641) z_2692)))))
(assert (forall ((p_590 R_637) (q_360 R_637))
	(reck_11 nil_437 p_590 q_360 nil_439)))
(assert (forall ((p_591 R_637))
	(=>	(and true
			(reck_10 true_433 p_591 (cons_376 A_118 (cons_376 A_118 (cons_376 B_128 (cons_376 B_128 nil_438))))))
		false)))
(check-sat)
