...
(assert (forall ((x_45748 It_4) (x_45749 list_176) (x_45750 It_4) (x_45751 list_176))
	(=> (diseqIt_4 x_45748 x_45750)
	    (diseqlist_176 (cons_176 x_45748 x_45749) (cons_176 x_45750 x_45751)))))
(assert (forall ((x_45748 It_4) (x_45749 list_176) (x_45750 It_4) (x_45751 list_176))
	(=> (diseqlist_176 x_45749 x_45751)
	    (diseqlist_176 (cons_176 x_45748 x_45749) (cons_176 x_45750 x_45751)))))
...
(assert (forall ((x_45714 Bool_244) (x_45703 It_4) (x_45704 list_176) (x_45702 list_176))
	(=> (isPrefix_4 x_45714 x_45702 x_45704)
	    (isPrefix_4 x_45714 (cons_176 x_45703 x_45702) (cons_176 x_45703 x_45704)))))
(assert (forall ((x_45703 It_4) (x_45704 list_176) (z_1455 It_4) (x_45702 list_176))
	(=> (diseqIt_4 z_1455 x_45703)
	    (isPrefix_4 false_244 (cons_176 z_1455 x_45702) (cons_176 x_45703 x_45704)))))
...
(assert (forall ((x_45719 Bool_244) (x_45709 It_4) (x_45710 list_176) (x_45707 It_4) (x_45708 list_176))
	(=> (isRelaxedPrefix_4 x_45719 (cons_176 x_45707 x_45708) x_45710)
	    (isRelaxedPrefix_4 x_45719 (cons_176 x_45709 (cons_176 x_45707 x_45708)) (cons_176 x_45709 x_45710)))))
(assert (forall ((x_45721 Bool_244) (x_45709 It_4) (x_45710 list_176) (x_45707 It_4) (x_45708 list_176) (z_1456 It_4))
	(=>	(and (diseqIt_4 z_1456 x_45709)
			(isPrefix_4 x_45721 (cons_176 x_45707 x_45708) (cons_176 x_45709 x_45710)))
		(isRelaxedPrefix_4 x_45721 (cons_176 z_1456 (cons_176 x_45707 x_45708)) (cons_176 x_45709 x_45710)))))
...
(assert (forall ((x_45727 list_176) (z_1457 It_4) (xs_481 list_176) (y_1616 list_176))
	(=> (x_45711 x_45727 xs_481 y_1616)
	    (x_45711 (cons_176 z_1457 x_45727) (cons_176 z_1457 xs_481) y_1616))))
...
(assert (forall ((x_45729 list_176) (x_45730 list_176) (x_45713 It_4) (xs_482 list_176) (ys_146 list_176))
	(=>	(and true
			(x_45711 x_45729 xs_482 (cons_176 x_45713 nil_201))
			(x_45711 x_45730 xs_482 ys_146)
			(isRelaxedPrefix_4 false_244 x_45729 x_45730))
		false)))
(check-sat)
