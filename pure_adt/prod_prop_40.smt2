...
(declare-datatypes ((Nat_577 0)) (((Z_2040 ) (S_466 (projS_188 Nat_577)))))
(declare-fun diseqNat_577 (Nat_577 Nat_577) Bool)
(declare-fun projS_189 (Nat_577 Nat_577) Bool)
(declare-fun isZ_433 (Nat_577) Bool)
(declare-fun isS_433 (Nat_577) Bool)
(assert (forall ((x_55258 Nat_577))
	(projS_189 x_55258 (S_466 x_55258))))
(assert (isZ_433 Z_2040))
(assert (forall ((x_55260 Nat_577))
	(isS_433 (S_466 x_55260))))
(assert (forall ((x_55261 Nat_577))
	(diseqNat_577 Z_2040 (S_466 x_55261))))
(assert (forall ((x_55262 Nat_577))
	(diseqNat_577 (S_466 x_55262) Z_2040)))
(assert (forall ((x_55263 Nat_577) (x_55264 Nat_577))
	(=> (diseqNat_577 x_55263 x_55264)
	    (diseqNat_577 (S_466 x_55263) (S_466 x_55264)))))
(declare-datatypes ((list_242 0)) (((nil_272 ) (cons_242 (head_484 Nat_577) (tail_484 list_242)))))
(declare-fun diseqlist_242 (list_242 list_242) Bool)
(declare-fun head_485 (Nat_577 list_242) Bool)
(declare-fun tail_485 (list_242 list_242) Bool)
(declare-fun isnil_272 (list_242) Bool)
(declare-fun iscons_242 (list_242) Bool)
(assert (forall ((x_55266 Nat_577) (x_55267 list_242))
	(head_485 x_55266 (cons_242 x_55266 x_55267))))
(assert (forall ((x_55266 Nat_577) (x_55267 list_242))
	(tail_485 x_55267 (cons_242 x_55266 x_55267))))
(assert (isnil_272 nil_272))
(assert (forall ((x_55269 Nat_577) (x_55270 list_242))
	(iscons_242 (cons_242 x_55269 x_55270))))
(assert (forall ((x_55271 Nat_577) (x_55272 list_242))
	(diseqlist_242 nil_272 (cons_242 x_55271 x_55272))))
(assert (forall ((x_55273 Nat_577) (x_55274 list_242))
	(diseqlist_242 (cons_242 x_55273 x_55274) nil_272)))
(assert (forall ((x_55275 Nat_577) (x_55276 list_242) (x_55277 Nat_577) (x_55278 list_242))
	(=> (diseqNat_577 x_55275 x_55277)
	    (diseqlist_242 (cons_242 x_55275 x_55276) (cons_242 x_55277 x_55278)))))
(assert (forall ((x_55275 Nat_577) (x_55276 list_242) (x_55277 Nat_577) (x_55278 list_242))
	(=> (diseqlist_242 x_55276 x_55278)
	    (diseqlist_242 (cons_242 x_55275 x_55276) (cons_242 x_55277 x_55278)))))
...
(declare-fun x_55217 (Bool_339 Nat_577 Nat_577) Bool)
(assert (forall ((x_55228 Bool_339) (y_2275 Nat_577) (x_55219 Nat_577))
	(=> (x_55217 x_55228 x_55219 y_2275)
	    (x_55217 x_55228 (S_466 x_55219) (S_466 y_2275)))))
(assert (forall ((x_55219 Nat_577))
	(x_55217 false_339 (S_466 x_55219) Z_2040)))
(assert (forall ((z_2041 Nat_577))
	(x_55217 false_339 Z_2040 (S_466 z_2041))))
(assert (x_55217 true_339 Z_2040 Z_2040))
(declare-fun elem_18 (Bool_339 Nat_577 list_242) Bool)
(assert (forall ((x_55233 Bool_339) (x_55234 Bool_339) (x_55235 Bool_339) (z_2042 Nat_577) (xs_651 list_242) (x_55220 Nat_577))
	(=>	(and (x_55217 x_55234 x_55220 z_2042)
			(elem_18 x_55235 x_55220 xs_651)
			(barbar_6 x_55233 x_55234 x_55235))
		(elem_18 x_55233 x_55220 (cons_242 z_2042 xs_651)))))
(assert (forall ((x_55220 Nat_577))
	(elem_18 false_339 x_55220 nil_272)))
(declare-fun union_2 (list_242 list_242 list_242) Bool)
(assert (forall ((x_55239 list_242) (z_2043 Nat_577) (xs_652 list_242) (y_2277 list_242))
	(=>	(and (union_2 x_55239 xs_652 y_2277)
			(elem_18 true_339 z_2043 y_2277))
		(union_2 x_55239 (cons_242 z_2043 xs_652) y_2277))))
(assert (forall ((x_55243 list_242) (z_2043 Nat_577) (xs_652 list_242) (y_2277 list_242))
	(=>	(and (union_2 x_55243 xs_652 y_2277)
			(elem_18 false_339 z_2043 y_2277))
		(union_2 (cons_242 z_2043 x_55243) (cons_242 z_2043 xs_652) y_2277))))
...
(assert (forall ((x_55247 Bool_339) (x_55248 Bool_339) (x_55249 Bool_339) (z_2044 Nat_577) (xs_653 list_242) (y_2279 list_242))
	(=>	(and (elem_18 x_55248 z_2044 y_2279)
			(subset_0 x_55249 xs_653 y_2279)
			(x_55222 x_55247 x_55248 x_55249))
		(subset_0 x_55247 (cons_242 z_2044 xs_653) y_2279))))
...
(assert (forall ((x_55252 list_242) (x_55225 list_242) (y_2280 list_242))
	(=>	(and true
			(diseqlist_242 x_55252 y_2280)
			(subset_0 true_339 x_55225 y_2280)
			(union_2 x_55252 x_55225 y_2280))
		false)))
(check-sat)
