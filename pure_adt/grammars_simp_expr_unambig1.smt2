...
(assert (forall ((x_127975 Tok_4) (x_127976 list_420) (x_127977 Tok_4) (x_127978 list_420))
	(=> (diseqTok_4 x_127975 x_127977)
	    (diseqlist_414 (cons_414 x_127975 x_127976) (cons_414 x_127977 x_127978)))))
(assert (forall ((x_127975 Tok_4) (x_127976 list_420) (x_127977 Tok_4) (x_127978 list_420))
	(=> (diseqlist_414 x_127976 x_127978)
	    (diseqlist_414 (cons_414 x_127975 x_127976) (cons_414 x_127977 x_127978)))))
...
(assert (forall ((x_127994 E_71) (x_127995 E_71) (x_127996 E_71) (x_127997 E_71))
	(=> (diseqE_11 x_127994 x_127996)
	    (diseqE_11 (Plus_141 x_127994 x_127995) (Plus_141 x_127996 x_127997)))))
(assert (forall ((x_127994 E_71) (x_127995 E_71) (x_127996 E_71) (x_127997 E_71))
	(=> (diseqE_11 x_127995 x_127997)
	    (diseqE_11 (Plus_141 x_127994 x_127995) (Plus_141 x_127996 x_127997)))))
...
(assert (forall ((x_127946 list_420) (z_2812 Tok_4) (xs_918 list_420) (y_3282 list_420))
	(=> (x_127942 x_127946 xs_918 y_3282)
	    (x_127942 (cons_414 z_2812 x_127946) (cons_414 z_2812 xs_918) y_3282))))
...
(assert (forall ((x_127950 list_420) (x_127951 list_420) (x_127952 list_420) (x_127953 list_420) (x_127954 list_420) (x_127955 list_420) (a_134 E_71) (b_151 E_71))
	(=>	(and (lin_4 x_127951 a_134)
			(lin_4 x_127952 b_151)
			(x_127942 x_127953 x_127952 (cons_414 D_10 nil_482))
			(x_127942 x_127954 (cons_414 Pl_3 nil_482) x_127953)
			(x_127942 x_127955 x_127951 x_127954)
			(x_127942 x_127950 (cons_414 C_90 nil_482) x_127955))
		(lin_4 x_127950 (Plus_141 a_134 b_151)))))
