...
(assert (forall ((x_108734 Bool_423) (x_108735 list_368) (x_108736 Bool_423) (x_108737 list_368))
	(=> (diseqBool_208 x_108734 x_108736)
	    (diseqlist_362 (cons_362 x_108734 x_108735) (cons_362 x_108736 x_108737)))))
(assert (forall ((x_108734 Bool_423) (x_108735 list_368) (x_108736 Bool_423) (x_108737 list_368))
	(=> (diseqlist_362 x_108735 x_108737)
	    (diseqlist_362 (cons_362 x_108734 x_108735) (cons_362 x_108736 x_108737)))))
...
(assert (forall ((x_108751 T_29) (x_108752 list_369) (x_108753 T_29) (x_108754 list_369))
	(=> (diseqT_27 x_108751 x_108753)
	    (diseqlist_363 (cons_363 x_108751 x_108752) (cons_363 x_108753 x_108754)))))
(assert (forall ((x_108751 T_29) (x_108752 list_369) (x_108753 T_29) (x_108754 list_369))
	(=> (diseqlist_363 x_108752 x_108754)
	    (diseqlist_363 (cons_363 x_108751 x_108752) (cons_363 x_108753 x_108754)))))
...
(assert (forall ((x_108760 list_369) (x_108761 list_369) (x_108762 list_369) (x_108763 list_369))
	(=> (diseqlist_363 x_108760 x_108762)
	    (diseqpair_86 (pair_173 x_108760 x_108761) (pair_173 x_108762 x_108763)))))
(assert (forall ((x_108760 list_369) (x_108761 list_369) (x_108762 list_369) (x_108763 list_369))
	(=> (diseqlist_363 x_108761 x_108763)
	    (diseqpair_86 (pair_173 x_108760 x_108761) (pair_173 x_108762 x_108763)))))
...
(assert (forall ((x_108774 pair_172) (x_108775 list_370) (x_108776 pair_172) (x_108777 list_370))
	(=> (diseqpair_86 x_108774 x_108776)
	    (diseqlist_364 (cons_364 x_108774 x_108775) (cons_364 x_108776 x_108777)))))
(assert (forall ((x_108774 pair_172) (x_108775 list_370) (x_108776 pair_172) (x_108777 list_370))
	(=> (diseqlist_364 x_108775 x_108777)
	    (diseqlist_364 (cons_364 x_108774 x_108775) (cons_364 x_108776 x_108777)))))
...
(assert (forall ((x_108856 T_29) (x_108857 T_29))
	(=> (diseqT_27 x_108856 x_108857)
	    (diseqR_41 (Atom_41 x_108856) (Atom_41 x_108857)))))
(assert (forall ((x_108858 R_602) (x_108859 R_602) (x_108860 R_602) (x_108861 R_602))
	(=> (diseqR_41 x_108858 x_108860)
	    (diseqR_41 (x_108629 x_108858 x_108859) (x_108629 x_108860 x_108861)))))
(assert (forall ((x_108858 R_602) (x_108859 R_602) (x_108860 R_602) (x_108861 R_602))
	(=> (diseqR_41 x_108859 x_108861)
	    (diseqR_41 (x_108629 x_108858 x_108859) (x_108629 x_108860 x_108861)))))
(assert (forall ((x_108862 R_602) (x_108863 R_602) (x_108864 R_602) (x_108865 R_602))
	(=> (diseqR_41 x_108862 x_108864)
	    (diseqR_41 (x_108630 x_108862 x_108863) (x_108630 x_108864 x_108865)))))
(assert (forall ((x_108862 R_602) (x_108863 R_602) (x_108864 R_602) (x_108865 R_602))
	(=> (diseqR_41 x_108863 x_108865)
	    (diseqR_41 (x_108630 x_108862 x_108863) (x_108630 x_108864 x_108865)))))
(assert (forall ((x_108866 R_602) (x_108867 R_602))
	(=> (diseqR_41 x_108866 x_108867)
	    (diseqR_41 (Star_41 x_108866) (Star_41 x_108867)))))
...
(assert (forall ((x_108650 list_370) (bs_20 list_369) (cs_6 list_369) (x_108632 list_370) (x_108631 T_29))
	(=> (splits_8 x_108650 x_108631 x_108632)
	    (splits_8 (cons_364 (pair_173 (cons_363 x_108631 bs_20) cs_6) x_108650) x_108631 (cons_364 (pair_173 bs_20 cs_6) x_108632)))))
...
(assert (forall ((x_108653 list_370) (x_108654 list_370) (y_2999 T_29) (xs_859 list_369))
	(=>	(and (splits_9 x_108653 xs_859)
			(splits_8 x_108654 y_2999 x_108653))
		(splits_9 (cons_364 (pair_173 nil_420 (cons_363 y_2999 xs_859)) x_108654) (cons_363 y_2999 xs_859)))))
...
(assert (forall ((x_108656 Bool_423) (x_108657 Bool_423) (y_3000 Bool_423) (xs_860 list_368))
	(=>	(and (or_439 x_108657 xs_860)
			(or_440 x_108656 y_3000 x_108657))
		(or_439 x_108656 (cons_362 y_3000 xs_860)))))
...
(assert (forall ((x_108660 Bool_423) (x_108661 Bool_423) (x_108662 Bool_423) (r_603 R_602) (q_312 R_602))
	(=>	(and (eps_83 x_108661 r_603)
			(eps_83 x_108662 q_312)
			(and_428 x_108660 x_108661 x_108662))
		(eps_83 x_108660 (x_108630 r_603 q_312)))))
(assert (forall ((x_108663 Bool_423) (x_108664 Bool_423) (x_108665 Bool_423) (p_552 R_602) (q_313 R_602))
	(=>	(and (eps_83 x_108664 p_552)
			(eps_83 x_108665 q_313)
			(or_440 x_108663 x_108664 x_108665))
		(eps_83 x_108663 (x_108629 p_552 q_313)))))
...
(assert (forall ((x_108670 R_602) (p_553 R_602) (y_3002 T_29))
	(=> (step_41 x_108670 p_553 y_3002)
	    (step_41 (x_108630 x_108670 (Star_41 p_553)) (Star_41 p_553) y_3002))))
(assert (forall ((x_108673 R_602) (x_108674 R_602) (r_604 R_602) (q_314 R_602) (y_3002 T_29))
	(=>	(and (step_41 x_108673 r_604 y_3002)
			(step_41 x_108674 q_314 y_3002)
			(eps_83 true_423 r_604))
		(step_41 (x_108629 (x_108630 x_108673 q_314) x_108674) (x_108630 r_604 q_314) y_3002))))
(assert (forall ((x_108677 R_602) (r_604 R_602) (q_314 R_602) (y_3002 T_29))
	(=>	(and (step_41 x_108677 r_604 y_3002)
			(eps_83 false_423 r_604))
		(step_41 (x_108629 (x_108630 x_108677 q_314) Nil_422) (x_108630 r_604 q_314) y_3002))))
(assert (forall ((x_108679 R_602) (x_108680 R_602) (p_554 R_602) (q_315 R_602) (y_3002 T_29))
	(=>	(and (step_41 x_108679 p_554 y_3002)
			(step_41 x_108680 q_315 y_3002))
		(step_41 (x_108629 x_108679 x_108680) (x_108629 p_554 q_315) y_3002))))
(assert (forall ((b_118 T_29))
	(step_41 Eps_82 (Atom_41 b_118) b_118)))
(assert (forall ((b_118 T_29) (y_3002 T_29))
	(=> (diseqT_27 b_118 y_3002)
	    (step_41 Nil_422 (Atom_41 b_118) y_3002))))
...
(assert (forall ((x_108685 Bool_423) (x_108686 R_602) (z_2601 T_29) (xs_861 list_369) (x_108639 R_602))
	(=>	(and (step_41 x_108686 x_108639 z_2601)
			(rec_27 x_108685 x_108686 xs_861))
		(rec_27 x_108685 x_108639 (cons_363 z_2601 xs_861)))))
(assert (forall ((x_108688 Bool_423) (x_108639 R_602))
	(=> (eps_83 x_108688 x_108639)
	    (rec_27 x_108688 x_108639 nil_420))))
...
(assert (forall ((x_108691 Bool_423) (x_108641 T_29) (x_108642 list_369) (p_555 R_602))
	(=>	(and (rec_27 x_108691 (x_108630 p_555 (Star_41 p_555)) (cons_363 x_108641 x_108642))
			(eps_83 false_423 p_555))
		(reck_8 x_108691 (Star_41 p_555) (cons_363 x_108641 x_108642)))))
(assert (forall ((x_108641 T_29) (x_108642 list_369) (p_555 R_602))
	(=> (eps_83 true_423 p_555)
	    (reck_8 false_423 (Star_41 p_555) (cons_363 x_108641 x_108642)))))
...
(assert (forall ((x_108696 Bool_423) (x_108697 list_370) (x_108698 list_368) (r_605 R_602) (q_316 R_602) (y_3004 list_369))
	(=>	(and (splits_9 x_108697 y_3004)
			(reck_9 x_108698 r_605 q_316 x_108697)
			(or_439 x_108696 x_108698))
		(reck_8 x_108696 (x_108630 r_605 q_316) y_3004))))
(assert (forall ((x_108700 Bool_423) (x_108701 Bool_423) (x_108702 Bool_423) (p_556 R_602) (q_317 R_602) (y_3004 list_369))
	(=>	(and (reck_8 x_108701 p_556 y_3004)
			(reck_8 x_108702 q_317 y_3004)
			(or_440 x_108700 x_108701 x_108702))
		(reck_8 x_108700 (x_108629 p_556 q_317) y_3004))))
...
(assert (forall ((b_119 T_29) (c_65 T_29))
	(=> (diseqT_27 c_65 b_119)
	    (reck_8 false_423 (Atom_41 c_65) (cons_363 b_119 nil_420)))))
...
(assert (forall ((x_108720 Bool_423) (x_108711 Bool_423) (x_108712 Bool_423) (x_108713 list_368) (l_58 list_369) (r_606 list_369) (z_2603 list_370) (p_557 R_602) (q_318 R_602))
	(=>	(and (reck_8 x_108711 p_557 l_58)
			(rec_27 x_108712 q_318 r_606)
			(reck_9 x_108713 p_557 q_318 z_2603)
			(and_428 x_108720 x_108711 x_108712))
		(reck_9 (cons_362 x_108720 x_108713) p_557 q_318 (cons_364 (pair_173 l_58 r_606) z_2603)))))
(assert (forall ((p_557 R_602) (q_318 R_602))
	(reck_9 nil_419 p_557 q_318 nil_421)))
(assert (forall ((p_558 R_602))
	(=>	(and true
			(reck_8 true_423 p_558 (cons_363 A_111 (cons_363 B_117 (cons_363 A_111 (cons_363 B_117 nil_420))))))
		false)))
(check-sat)
