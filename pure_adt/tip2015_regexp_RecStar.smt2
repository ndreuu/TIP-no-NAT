...
(assert (forall ((x_25264 A_27) (x_25265 A_27))
	(=> (diseqA_6 x_25264 x_25265)
	    (diseqR_6 (Atom_6 x_25264) (Atom_6 x_25265)))))
(assert (forall ((x_25266 R_191) (x_25267 R_191) (x_25268 R_191) (x_25269 R_191))
	(=> (diseqR_6 x_25266 x_25268)
	    (diseqR_6 (Plus_48 x_25266 x_25267) (Plus_48 x_25268 x_25269)))))
(assert (forall ((x_25266 R_191) (x_25267 R_191) (x_25268 R_191) (x_25269 R_191))
	(=> (diseqR_6 x_25267 x_25269)
	    (diseqR_6 (Plus_48 x_25266 x_25267) (Plus_48 x_25268 x_25269)))))
(assert (forall ((x_25270 R_191) (x_25271 R_191) (x_25272 R_191) (x_25273 R_191))
	(=> (diseqR_6 x_25270 x_25272)
	    (diseqR_6 (Seq_12 x_25270 x_25271) (Seq_12 x_25272 x_25273)))))
(assert (forall ((x_25270 R_191) (x_25271 R_191) (x_25272 R_191) (x_25273 R_191))
	(=> (diseqR_6 x_25271 x_25273)
	    (diseqR_6 (Seq_12 x_25270 x_25271) (Seq_12 x_25272 x_25273)))))
(assert (forall ((x_25274 R_191) (x_25275 R_191))
	(=> (diseqR_6 x_25274 x_25275)
	    (diseqR_6 (Star_6 x_25274) (Star_6 x_25275)))))
...
(assert (forall ((x_25286 A_27) (x_25287 list_116) (x_25288 A_27) (x_25289 list_116))
	(=> (diseqA_6 x_25286 x_25288)
	    (diseqlist_116 (cons_116 x_25286 x_25287) (cons_116 x_25288 x_25289)))))
(assert (forall ((x_25286 A_27) (x_25287 list_116) (x_25288 A_27) (x_25289 list_116))
	(=> (diseqlist_116 x_25287 x_25289)
	    (diseqlist_116 (cons_116 x_25286 x_25287) (cons_116 x_25288 x_25289)))))
...
(assert (forall ((x_25138 Bool_161) (x_25139 Bool_161) (x_25140 Bool_161) (r_192 R_191) (q_49 R_191))
	(=>	(and (eps_13 x_25139 r_192)
			(eps_13 x_25140 q_49)
			(and_161 x_25138 x_25139 x_25140))
		(eps_13 x_25138 (Seq_12 r_192 q_49)))))
(assert (forall ((x_25141 Bool_161) (x_25142 Bool_161) (x_25143 Bool_161) (p_138 R_191) (q_50 R_191))
	(=>	(and (eps_13 x_25142 p_138)
			(eps_13 x_25143 q_50)
			(or_163 x_25141 x_25142 x_25143))
		(eps_13 x_25141 (Plus_48 p_138 q_50)))))
...
(assert (forall ((x_23109 R_191))
	(=> (eps_13 true_161 x_23109)
	    (epsR_6 Eps_12 x_23109))))
(assert (forall ((x_23109 R_191))
	(=> (eps_13 false_161 x_23109)
	    (epsR_6 Nil_128 x_23109))))
(declare-fun step_6 (R_191 R_191 A_27) Bool)
(assert (forall ((x_25151 R_191) (x_25152 R_191) (p_139 R_191) (y_932 A_27))
	(=>	(and (step_6 x_25152 p_139 y_932)
			(seq_13 x_25151 x_25152 (Star_6 p_139)))
		(step_6 x_25151 (Star_6 p_139) y_932))))
(assert (forall ((x_25154 R_191) (x_25155 R_191) (x_25156 R_191) (x_25157 R_191) (x_25158 R_191) (x_25159 R_191) (r_193 R_191) (q_51 R_191) (y_932 A_27))
	(=>	(and (step_6 x_25155 r_193 y_932)
			(seq_13 x_25156 x_25155 q_51)
			(epsR_6 x_25157 r_193)
			(step_6 x_25158 q_51 y_932)
			(seq_13 x_25159 x_25157 x_25158)
			(plus_49 x_25154 x_25156 x_25159))
		(step_6 x_25154 (Seq_12 r_193 q_51) y_932))))
(assert (forall ((x_25161 R_191) (x_25162 R_191) (x_25163 R_191) (p_140 R_191) (q_52 R_191) (y_932 A_27))
	(=>	(and (step_6 x_25162 p_140 y_932)
			(step_6 x_25163 q_52 y_932)
			(plus_49 x_25161 x_25162 x_25163))
		(step_6 x_25161 (Plus_48 p_140 q_52) y_932))))
(assert (forall ((a_28 A_27) (y_932 A_27))
	(=> (eqA_6 true_161 a_28 y_932)
	    (step_6 Eps_12 (Atom_6 a_28) y_932))))
(assert (forall ((a_28 A_27) (y_932 A_27))
	(=> (eqA_6 false_161 a_28 y_932)
	    (step_6 Nil_128 (Atom_6 a_28) y_932))))
...
(assert (forall ((x_25171 Bool_161) (x_25172 R_191) (z_914 A_27) (xs_295 list_116) (x_23112 R_191))
	(=>	(and (step_6 x_25172 x_23112 z_914)
			(recognise_6 x_25171 x_25172 xs_295))
		(recognise_6 x_25171 x_23112 (cons_116 z_914 xs_295)))))
(assert (forall ((x_25174 Bool_161) (x_23112 R_191))
	(=> (eps_13 x_25174 x_23112)
	    (recognise_6 x_25174 x_23112 nil_129))))
(assert (forall ((x_25176 Bool_161) (x_25177 Bool_161) (x_23113 A_27) (y_934 list_116) (p_141 R_191))
	(=>	(and true
			(diseqBool_67 x_25176 x_25177)
			(recognise_6 x_25176 (Star_6 p_141) (cons_116 x_23113 y_934))
			(recognise_6 x_25177 (Seq_12 p_141 (Star_6 p_141)) (cons_116 x_23113 y_934)))
		false)))
(assert (forall ((p_141 R_191))
	(=>	(and true
			(recognise_6 false_161 (Star_6 p_141) nil_129))
		false)))
(check-sat)
