...
(declare-datatypes ((Nat_87 0)) (((Z_246 ) (S_87 (projS_84 Nat_87)))))
(declare-fun diseqNat_87 (Nat_87 Nat_87) Bool)
(declare-fun projS_85 (Nat_87 Nat_87) Bool)
(declare-fun isZ_87 (Nat_87) Bool)
(declare-fun isS_87 (Nat_87) Bool)
(assert (forall ((x_2427 Nat_87))
	(projS_85 x_2427 (S_87 x_2427))))
(assert (isZ_87 Z_246))
(assert (forall ((x_2429 Nat_87))
	(isS_87 (S_87 x_2429))))
(assert (forall ((x_2430 Nat_87))
	(diseqNat_87 Z_246 (S_87 x_2430))))
(assert (forall ((x_2431 Nat_87))
	(diseqNat_87 (S_87 x_2431) Z_246)))
(assert (forall ((x_2432 Nat_87) (x_2433 Nat_87))
	(=> (diseqNat_87 x_2432 x_2433)
	    (diseqNat_87 (S_87 x_2432) (S_87 x_2433)))))
(declare-fun x_2406 (Bool_45 Nat_87 Nat_87) Bool)
(assert (forall ((x_2412 Bool_45) (y_195 Nat_87) (x_2408 Nat_87))
	(=> (x_2406 x_2412 x_2408 y_195)
	    (x_2406 x_2412 (S_87 x_2408) (S_87 y_195)))))
(assert (forall ((x_2408 Nat_87))
	(x_2406 false_45 (S_87 x_2408) Z_246)))
(assert (forall ((z_247 Nat_87))
	(x_2406 false_45 Z_246 (S_87 z_247))))
(assert (x_2406 true_45 Z_246 Z_246))
(declare-fun x_2409 (Bool_45 Nat_87 Nat_87) Bool)
(assert (forall ((x_2417 Bool_45) (x_2411 Nat_87) (z_248 Nat_87))
	(=> (x_2409 x_2417 z_248 x_2411)
	    (x_2409 x_2417 (S_87 z_248) (S_87 x_2411)))))
(assert (forall ((z_248 Nat_87))
	(x_2409 false_45 (S_87 z_248) Z_246)))
(assert (forall ((y_196 Nat_87))
	(x_2409 true_45 Z_246 y_196)))
(assert (forall ((x_2421 Bool_45) (x_2422 Bool_45) (n_18 Nat_87))
	(=>	(and true
			(diseqBool_18 x_2421 x_2422)
			(x_2409 x_2421 n_18 Z_246)
			(x_2406 x_2422 n_18 Z_246))
		false)))
(check-sat)
