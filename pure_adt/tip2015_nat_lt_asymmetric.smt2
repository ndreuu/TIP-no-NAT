...
(declare-datatypes ((Nat_294 0)) (((zero_54 ) (succ_53 (p_150 Nat_294)))))
(declare-fun diseqNat_294 (Nat_294 Nat_294) Bool)
(declare-fun p_151 (Nat_294 Nat_294) Bool)
(declare-fun iszero_53 (Nat_294) Bool)
(declare-fun issucc_53 (Nat_294) Bool)
(assert (forall ((x_25820 Nat_294))
	(p_151 x_25820 (succ_53 x_25820))))
(assert (iszero_53 zero_54))
(assert (forall ((x_25822 Nat_294))
	(issucc_53 (succ_53 x_25822))))
(assert (forall ((x_25823 Nat_294))
	(diseqNat_294 zero_54 (succ_53 x_25823))))
(assert (forall ((x_25824 Nat_294))
	(diseqNat_294 (succ_53 x_25824) zero_54)))
(assert (forall ((x_25825 Nat_294) (x_25826 Nat_294))
	(=> (diseqNat_294 x_25825 x_25826)
	    (diseqNat_294 (succ_53 x_25825) (succ_53 x_25826)))))
(declare-fun lt_175 (Bool_168 Nat_294 Nat_294) Bool)
(assert (forall ((x_25810 Bool_168) (n_56 Nat_294) (z_958 Nat_294))
	(=> (lt_175 x_25810 n_56 z_958)
	    (lt_175 x_25810 (succ_53 n_56) (succ_53 z_958)))))
(assert (forall ((z_958 Nat_294))
	(lt_175 true_168 zero_54 (succ_53 z_958))))
(assert (forall ((x_25808 Nat_294))
	(lt_175 false_168 x_25808 zero_54)))
(assert (forall ((x_25809 Nat_294) (y_988 Nat_294))
	(=>	(and true
			(lt_175 true_168 x_25809 y_988)
			(lt_175 true_168 y_988 x_25809))
		false)))
(check-sat)
