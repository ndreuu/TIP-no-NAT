...
(declare-datatypes ((Nat_307 0)) (((zero_59 ) (succ_58 (p_161 Nat_307)))))
(declare-fun diseqNat_307 (Nat_307 Nat_307) Bool)
(declare-fun p_162 (Nat_307 Nat_307) Bool)
(declare-fun iszero_58 (Nat_307) Bool)
(declare-fun issucc_58 (Nat_307) Bool)
(assert (forall ((x_26575 Nat_307))
	(p_162 x_26575 (succ_58 x_26575))))
(assert (iszero_58 zero_59))
(assert (forall ((x_26577 Nat_307))
	(issucc_58 (succ_58 x_26577))))
(assert (forall ((x_26578 Nat_307))
	(diseqNat_307 zero_59 (succ_58 x_26578))))
(assert (forall ((x_26579 Nat_307))
	(diseqNat_307 (succ_58 x_26579) zero_59)))
(assert (forall ((x_26580 Nat_307) (x_26581 Nat_307))
	(=> (diseqNat_307 x_26580 x_26581)
	    (diseqNat_307 (succ_58 x_26580) (succ_58 x_26581)))))
(declare-fun leq_21 (Bool_176 Nat_307 Nat_307) Bool)
(assert (forall ((x_26563 Bool_176) (x_26560 Nat_307) (z_1012 Nat_307))
	(=> (leq_21 x_26563 z_1012 x_26560)
	    (leq_21 x_26563 (succ_58 z_1012) (succ_58 x_26560)))))
(assert (forall ((z_1012 Nat_307))
	(leq_21 false_176 (succ_58 z_1012) zero_59)))
(assert (forall ((y_1054 Nat_307))
	(leq_21 true_176 zero_59 y_1054)))
(declare-fun geq_0 (Bool_176 Nat_307 Nat_307) Bool)
(assert (forall ((x_26567 Bool_176) (x_26561 Nat_307) (y_1055 Nat_307))
	(=> (leq_21 x_26567 y_1055 x_26561)
	    (geq_0 x_26567 x_26561 y_1055))))
(assert (forall ((x_26562 Nat_307) (y_1056 Nat_307))
	(=>	(and true
			(diseqNat_307 x_26562 y_1056)
			(geq_0 true_176 x_26562 y_1056)
			(leq_21 true_176 x_26562 y_1056))
		false)))
(check-sat)
