...
(assert (forall ((x_7100 It_0) (x_7101 list_74) (x_7102 It_0) (x_7103 list_74))
	(=> (diseqIt_0 x_7100 x_7102)
	    (diseqlist_74 (cons_74 x_7100 x_7101) (cons_74 x_7102 x_7103)))))
(assert (forall ((x_7100 It_0) (x_7101 list_74) (x_7102 It_0) (x_7103 list_74))
	(=> (diseqlist_74 x_7101 x_7103)
	    (diseqlist_74 (cons_74 x_7100 x_7101) (cons_74 x_7102 x_7103)))))
...
(assert (forall ((x_7067 Bool_91) (x_7056 It_0) (x_7057 list_74) (x_7055 list_74))
	(=> (isPrefix_0 x_7067 x_7055 x_7057)
	    (isPrefix_0 x_7067 (cons_74 x_7056 x_7055) (cons_74 x_7056 x_7057)))))
(assert (forall ((x_7056 It_0) (x_7057 list_74) (z_486 It_0) (x_7055 list_74))
	(=> (diseqIt_0 z_486 x_7056)
	    (isPrefix_0 false_91 (cons_74 z_486 x_7055) (cons_74 x_7056 x_7057)))))
...
(assert (forall ((x_7072 Bool_91) (x_7062 It_0) (x_7063 list_74) (x_7060 It_0) (x_7061 list_74))
	(=> (isRelaxedPrefix_0 x_7072 (cons_74 x_7060 x_7061) x_7063)
	    (isRelaxedPrefix_0 x_7072 (cons_74 x_7062 (cons_74 x_7060 x_7061)) (cons_74 x_7062 x_7063)))))
(assert (forall ((x_7074 Bool_91) (x_7062 It_0) (x_7063 list_74) (x_7060 It_0) (x_7061 list_74) (z_487 It_0))
	(=>	(and (diseqIt_0 z_487 x_7062)
			(isPrefix_0 x_7074 (cons_74 x_7060 x_7061) (cons_74 x_7062 x_7063)))
		(isRelaxedPrefix_0 x_7074 (cons_74 z_487 (cons_74 x_7060 x_7061)) (cons_74 x_7062 x_7063)))))
...
(assert (forall ((x_7080 list_74) (z_488 It_0) (xs_144 list_74) (y_414 list_74))
	(=> (x_7064 x_7080 xs_144 y_414)
	    (x_7064 (cons_74 z_488 x_7080) (cons_74 z_488 xs_144) y_414))))
...
(assert (forall ((x_7082 list_74) (x_7066 It_0) (xs_145 list_74) (ys_36 list_74))
	(=>	(and true
			(x_7064 x_7082 xs_145 ys_36)
			(isRelaxedPrefix_0 false_91 (cons_74 x_7066 xs_145) x_7082))
		false)))
(check-sat)
