...
(declare-datatypes ((Nat_659 0)) (((S_553 (projS_240 Nat_659)) (Z_2371 ))))
(declare-fun diseqNat_659 (Nat_659 Nat_659) Bool)
(declare-fun projS_241 (Nat_659 Nat_659) Bool)
(declare-fun isS_515 (Nat_659) Bool)
(declare-fun isZ_515 (Nat_659) Bool)
(assert (forall ((x_70606 Nat_659))
	(projS_241 x_70606 (S_553 x_70606))))
(assert (forall ((x_70609 Nat_659))
	(isS_515 (S_553 x_70609))))
(assert (isZ_515 Z_2371))
(assert (forall ((x_70610 Nat_659))
	(diseqNat_659 (S_553 x_70610) Z_2371)))
(assert (forall ((x_70611 Nat_659))
	(diseqNat_659 Z_2371 (S_553 x_70611))))
(assert (forall ((x_70612 Nat_659) (x_70613 Nat_659))
	(=> (diseqNat_659 x_70612 x_70613)
	    (diseqNat_659 (S_553 x_70612) (S_553 x_70613)))))
(declare-datatypes ((list_318 0)) (((nil_358 ) (cons_315 (head_630 Nat_659) (tail_633 list_318)))))
(declare-fun diseqlist_315 (list_318 list_318) Bool)
(declare-fun head_631 (Nat_659 list_318) Bool)
(declare-fun tail_634 (list_318 list_318) Bool)
(declare-fun isnil_358 (list_318) Bool)
(declare-fun iscons_315 (list_318) Bool)
(assert (forall ((x_70615 Nat_659) (x_70616 list_318))
	(head_631 x_70615 (cons_315 x_70615 x_70616))))
(assert (forall ((x_70615 Nat_659) (x_70616 list_318))
	(tail_634 x_70616 (cons_315 x_70615 x_70616))))
(assert (isnil_358 nil_358))
(assert (forall ((x_70618 Nat_659) (x_70619 list_318))
	(iscons_315 (cons_315 x_70618 x_70619))))
(assert (forall ((x_70620 Nat_659) (x_70621 list_318))
	(diseqlist_315 nil_358 (cons_315 x_70620 x_70621))))
(assert (forall ((x_70622 Nat_659) (x_70623 list_318))
	(diseqlist_315 (cons_315 x_70622 x_70623) nil_358)))
(assert (forall ((x_70624 Nat_659) (x_70625 list_318) (x_70626 Nat_659) (x_70627 list_318))
	(=> (diseqNat_659 x_70624 x_70626)
	    (diseqlist_315 (cons_315 x_70624 x_70625) (cons_315 x_70626 x_70627)))))
(assert (forall ((x_70624 Nat_659) (x_70625 list_318) (x_70626 Nat_659) (x_70627 list_318))
	(=> (diseqlist_315 x_70625 x_70627)
	    (diseqlist_315 (cons_315 x_70624 x_70625) (cons_315 x_70626 x_70627)))))
(declare-fun eqNat_1 (Bool_395 Nat_659 Nat_659) Bool)
(assert (eqNat_1 true_395 Z_2371 Z_2371))
(assert (forall ((x_70578 Nat_659))
	(eqNat_1 false_395 Z_2371 (S_553 x_70578))))
(assert (forall ((z_2372 Nat_659))
	(eqNat_1 false_395 (S_553 z_2372) Z_2371)))
(assert (forall ((x_70585 Bool_395) (y_2664 Nat_659) (z_2372 Nat_659))
	(=> (eqNat_1 x_70585 z_2372 y_2664)
	    (eqNat_1 x_70585 (S_553 z_2372) (S_553 y_2664)))))
...
(declare-fun elem_28 (Bool_395 Nat_659 list_318) Bool)
(assert (forall ((x_70589 Bool_395) (x_70590 Bool_395) (x_70591 Bool_395) (z_2373 Nat_659) (xs_787 list_318) (x_70580 Nat_659))
	(=>	(and (eqNat_1 x_70590 x_70580 z_2373)
			(elem_28 x_70591 x_70580 xs_787)
			(barbar_14 x_70589 x_70590 x_70591))
		(elem_28 x_70589 x_70580 (cons_315 z_2373 xs_787)))))
(assert (forall ((x_70580 Nat_659))
	(elem_28 false_395 x_70580 nil_358)))
(declare-fun union_4 (list_318 list_318 list_318) Bool)
(assert (forall ((x_70595 list_318) (z_2374 Nat_659) (xs_788 list_318) (y_2667 list_318))
	(=>	(and (union_4 x_70595 xs_788 y_2667)
			(elem_28 true_395 z_2374 y_2667))
		(union_4 x_70595 (cons_315 z_2374 xs_788) y_2667))))
(assert (forall ((x_70599 list_318) (z_2374 Nat_659) (xs_788 list_318) (y_2667 list_318))
	(=>	(and (union_4 x_70599 xs_788 y_2667)
			(elem_28 false_395 z_2374 y_2667))
		(union_4 (cons_315 z_2374 x_70599) (cons_315 z_2374 xs_788) y_2667))))
...
(assert (forall ((x_70601 list_318) (x_70602 list_318) (xs_789 list_318) (ys_220 list_318))
	(=>	(and true
			(diseqlist_315 x_70601 x_70602)
			(union_4 x_70601 xs_789 ys_220)
			(union_4 x_70602 ys_220 xs_789))
		false)))
(check-sat)
