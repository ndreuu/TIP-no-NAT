...
(assert (forall ((x_59058 Bool_379) (x_59059 list_294) (x_59060 Bool_379) (x_59061 list_294))
	(=> (diseqBool_172 x_59058 x_59060)
	    (diseqlist_292 (cons_292 x_59058 x_59059) (cons_292 x_59060 x_59061)))))
(assert (forall ((x_59058 Bool_379) (x_59059 list_294) (x_59060 Bool_379) (x_59061 list_294))
	(=> (diseqlist_292 x_59059 x_59061)
	    (diseqlist_292 (cons_292 x_59058 x_59059) (cons_292 x_59060 x_59061)))))
...
(assert (forall ((x_59075 T_3) (x_59076 list_295) (x_59077 T_3) (x_59078 list_295))
	(=> (diseqT_3 x_59075 x_59077)
	    (diseqlist_293 (cons_293 x_59075 x_59076) (cons_293 x_59077 x_59078)))))
(assert (forall ((x_59075 T_3) (x_59076 list_295) (x_59077 T_3) (x_59078 list_295))
	(=> (diseqlist_293 x_59076 x_59078)
	    (diseqlist_293 (cons_293 x_59075 x_59076) (cons_293 x_59077 x_59078)))))
...
(assert (forall ((x_59084 list_295) (x_59085 list_295) (x_59086 list_295) (x_59087 list_295))
	(=> (diseqlist_293 x_59084 x_59086)
	    (diseqpair_57 (pair_115 x_59084 x_59085) (pair_115 x_59086 x_59087)))))
(assert (forall ((x_59084 list_295) (x_59085 list_295) (x_59086 list_295) (x_59087 list_295))
	(=> (diseqlist_293 x_59085 x_59087)
	    (diseqpair_57 (pair_115 x_59084 x_59085) (pair_115 x_59086 x_59087)))))
...
(assert (forall ((x_59098 pair_114) (x_59099 list_296) (x_59100 pair_114) (x_59101 list_296))
	(=> (diseqpair_57 x_59098 x_59100)
	    (diseqlist_294 (cons_294 x_59098 x_59099) (cons_294 x_59100 x_59101)))))
(assert (forall ((x_59098 pair_114) (x_59099 list_296) (x_59100 pair_114) (x_59101 list_296))
	(=> (diseqlist_294 x_59099 x_59101)
	    (diseqlist_294 (cons_294 x_59098 x_59099) (cons_294 x_59100 x_59101)))))
...
(assert (forall ((x_59180 T_3) (x_59181 T_3))
	(=> (diseqT_3 x_59180 x_59181)
	    (diseqR_17 (Atom_17 x_59180) (Atom_17 x_59181)))))
(assert (forall ((x_59182 R_467) (x_59183 R_467) (x_59184 R_467) (x_59185 R_467))
	(=> (diseqR_17 x_59182 x_59184)
	    (diseqR_17 (x_58953 x_59182 x_59183) (x_58953 x_59184 x_59185)))))
(assert (forall ((x_59182 R_467) (x_59183 R_467) (x_59184 R_467) (x_59185 R_467))
	(=> (diseqR_17 x_59183 x_59185)
	    (diseqR_17 (x_58953 x_59182 x_59183) (x_58953 x_59184 x_59185)))))
(assert (forall ((x_59186 R_467) (x_59187 R_467) (x_59188 R_467) (x_59189 R_467))
	(=> (diseqR_17 x_59186 x_59188)
	    (diseqR_17 (x_58954 x_59186 x_59187) (x_58954 x_59188 x_59189)))))
(assert (forall ((x_59186 R_467) (x_59187 R_467) (x_59188 R_467) (x_59189 R_467))
	(=> (diseqR_17 x_59187 x_59189)
	    (diseqR_17 (x_58954 x_59186 x_59187) (x_58954 x_59188 x_59189)))))
(assert (forall ((x_59190 R_467) (x_59191 R_467))
	(=> (diseqR_17 x_59190 x_59191)
	    (diseqR_17 (Star_17 x_59190) (Star_17 x_59191)))))
...
(assert (forall ((x_58974 list_296) (bs_8 list_295) (cs_2 list_295) (x_58956 list_296) (x_58955 T_3))
	(=> (splits_4 x_58974 x_58955 x_58956)
	    (splits_4 (cons_294 (pair_115 (cons_293 x_58955 bs_8) cs_2) x_58974) x_58955 (cons_294 (pair_115 bs_8 cs_2) x_58956)))))
...
(assert (forall ((x_58977 list_296) (x_58978 list_296) (y_2545 T_3) (xs_750 list_295))
	(=>	(and (splits_5 x_58977 xs_750)
			(splits_4 x_58978 y_2545 x_58977))
		(splits_5 (cons_294 (pair_115 nil_326 (cons_293 y_2545 xs_750)) x_58978) (cons_293 y_2545 xs_750)))))
...
(assert (forall ((x_58980 Bool_379) (x_58981 Bool_379) (y_2546 Bool_379) (xs_751 list_294))
	(=>	(and (or_390 x_58981 xs_751)
			(or_391 x_58980 y_2546 x_58981))
		(or_390 x_58980 (cons_292 y_2546 xs_751)))))
...
(assert (forall ((x_58984 Bool_379) (x_58985 Bool_379) (x_58986 Bool_379) (r_468 R_467) (q_156 R_467))
	(=>	(and (eps_35 x_58985 r_468)
			(eps_35 x_58986 q_156)
			(and_380 x_58984 x_58985 x_58986))
		(eps_35 x_58984 (x_58954 r_468 q_156)))))
(assert (forall ((x_58987 Bool_379) (x_58988 Bool_379) (x_58989 Bool_379) (p_423 R_467) (q_157 R_467))
	(=>	(and (eps_35 x_58988 p_423)
			(eps_35 x_58989 q_157)
			(or_391 x_58987 x_58988 x_58989))
		(eps_35 x_58987 (x_58953 p_423 q_157)))))
...
(assert (forall ((x_58994 R_467) (p_424 R_467) (y_2548 T_3))
	(=> (step_17 x_58994 p_424 y_2548)
	    (step_17 (x_58954 x_58994 (Star_17 p_424)) (Star_17 p_424) y_2548))))
(assert (forall ((x_58997 R_467) (x_58998 R_467) (r_469 R_467) (q_158 R_467) (y_2548 T_3))
	(=>	(and (step_17 x_58997 r_469 y_2548)
			(step_17 x_58998 q_158 y_2548)
			(eps_35 true_379 r_469))
		(step_17 (x_58953 (x_58954 x_58997 q_158) x_58998) (x_58954 r_469 q_158) y_2548))))
(assert (forall ((x_59001 R_467) (r_469 R_467) (q_158 R_467) (y_2548 T_3))
	(=>	(and (step_17 x_59001 r_469 y_2548)
			(eps_35 false_379 r_469))
		(step_17 (x_58953 (x_58954 x_59001 q_158) Nil_328) (x_58954 r_469 q_158) y_2548))))
(assert (forall ((x_59003 R_467) (x_59004 R_467) (p_425 R_467) (q_159 R_467) (y_2548 T_3))
	(=>	(and (step_17 x_59003 p_425 y_2548)
			(step_17 x_59004 q_159 y_2548))
		(step_17 (x_58953 x_59003 x_59004) (x_58953 p_425 q_159) y_2548))))
(assert (forall ((b_50 T_3))
	(step_17 Eps_34 (Atom_17 b_50) b_50)))
(assert (forall ((b_50 T_3) (y_2548 T_3))
	(=> (diseqT_3 b_50 y_2548)
	    (step_17 Nil_328 (Atom_17 b_50) y_2548))))
...
(assert (forall ((x_59009 Bool_379) (x_59010 R_467) (z_2283 T_3) (xs_752 list_295) (x_58963 R_467))
	(=>	(and (step_17 x_59010 x_58963 z_2283)
			(rec_3 x_59009 x_59010 xs_752))
		(rec_3 x_59009 x_58963 (cons_293 z_2283 xs_752)))))
(assert (forall ((x_59012 Bool_379) (x_58963 R_467))
	(=> (eps_35 x_59012 x_58963)
	    (rec_3 x_59012 x_58963 nil_326))))
...
(assert (forall ((x_59015 Bool_379) (x_58965 T_3) (x_58966 list_295) (p_426 R_467))
	(=>	(and (rec_3 x_59015 (x_58954 p_426 (Star_17 p_426)) (cons_293 x_58965 x_58966))
			(eps_35 false_379 p_426))
		(reck_4 x_59015 (Star_17 p_426) (cons_293 x_58965 x_58966)))))
(assert (forall ((x_58965 T_3) (x_58966 list_295) (p_426 R_467))
	(=> (eps_35 true_379 p_426)
	    (reck_4 false_379 (Star_17 p_426) (cons_293 x_58965 x_58966)))))
...
(assert (forall ((x_59020 Bool_379) (x_59021 list_296) (x_59022 list_294) (r_470 R_467) (q_160 R_467) (y_2550 list_295))
	(=>	(and (splits_5 x_59021 y_2550)
			(reck_5 x_59022 r_470 q_160 x_59021)
			(or_390 x_59020 x_59022))
		(reck_4 x_59020 (x_58954 r_470 q_160) y_2550))))
(assert (forall ((x_59024 Bool_379) (x_59025 Bool_379) (x_59026 Bool_379) (p_427 R_467) (q_161 R_467) (y_2550 list_295))
	(=>	(and (reck_4 x_59025 p_427 y_2550)
			(reck_4 x_59026 q_161 y_2550)
			(or_391 x_59024 x_59025 x_59026))
		(reck_4 x_59024 (x_58953 p_427 q_161) y_2550))))
...
(assert (forall ((b_51 T_3) (c_29 T_3))
	(=> (diseqT_3 c_29 b_51)
	    (reck_4 false_379 (Atom_17 c_29) (cons_293 b_51 nil_326)))))
...
(assert (forall ((x_59044 Bool_379) (x_59035 Bool_379) (x_59036 Bool_379) (x_59037 list_294) (l_49 list_295) (r_471 list_295) (z_2285 list_296) (p_428 R_467) (q_162 R_467))
	(=>	(and (reck_4 x_59035 p_428 l_49)
			(rec_3 x_59036 q_162 r_471)
			(reck_5 x_59037 p_428 q_162 z_2285)
			(and_380 x_59044 x_59035 x_59036))
		(reck_5 (cons_292 x_59044 x_59037) p_428 q_162 (cons_294 (pair_115 l_49 r_471) z_2285)))))
(assert (forall ((p_428 R_467) (q_162 R_467))
	(reck_5 nil_325 p_428 q_162 nil_327)))
(assert (forall ((p_429 R_467))
	(=>	(and true
			(reck_4 true_379 p_429 (cons_293 A_63 (cons_293 B_49 (cons_293 B_49 nil_326)))))
		false)))
(check-sat)
