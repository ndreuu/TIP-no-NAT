...
(assert (forall ((x_33392 A_34) (x_33393 A_34))
	(=> (diseqA_8 x_33392 x_33393)
	    (diseqR_8 (Atom_8 x_33392) (Atom_8 x_33393)))))
(assert (forall ((x_33394 R_242) (x_33395 R_242) (x_33396 R_242) (x_33397 R_242))
	(=> (diseqR_8 x_33394 x_33396)
	    (diseqR_8 (Plus_67 x_33394 x_33395) (Plus_67 x_33396 x_33397)))))
(assert (forall ((x_33394 R_242) (x_33395 R_242) (x_33396 R_242) (x_33397 R_242))
	(=> (diseqR_8 x_33395 x_33397)
	    (diseqR_8 (Plus_67 x_33394 x_33395) (Plus_67 x_33396 x_33397)))))
(assert (forall ((x_33398 R_242) (x_33399 R_242) (x_33400 R_242) (x_33401 R_242))
	(=> (diseqR_8 x_33398 x_33400)
	    (diseqR_8 (Seq_16 x_33398 x_33399) (Seq_16 x_33400 x_33401)))))
(assert (forall ((x_33398 R_242) (x_33399 R_242) (x_33400 R_242) (x_33401 R_242))
	(=> (diseqR_8 x_33399 x_33401)
	    (diseqR_8 (Seq_16 x_33398 x_33399) (Seq_16 x_33400 x_33401)))))
(assert (forall ((x_33402 R_242) (x_33403 R_242))
	(=> (diseqR_8 x_33402 x_33403)
	    (diseqR_8 (Star_8 x_33402) (Star_8 x_33403)))))
...
(assert (forall ((x_33414 A_34) (x_33415 list_141) (x_33416 A_34) (x_33417 list_141))
	(=> (diseqA_8 x_33414 x_33416)
	    (diseqlist_141 (cons_141 x_33414 x_33415) (cons_141 x_33416 x_33417)))))
(assert (forall ((x_33414 A_34) (x_33415 list_141) (x_33416 A_34) (x_33417 list_141))
	(=> (diseqlist_141 x_33415 x_33417)
	    (diseqlist_141 (cons_141 x_33414 x_33415) (cons_141 x_33416 x_33417)))))
...
(assert (forall ((x_33267 Bool_202) (x_33268 Bool_202) (x_33269 Bool_202) (r_243 R_242) (q_71 R_242))
	(=>	(and (eps_17 x_33268 r_243)
			(eps_17 x_33269 q_71)
			(and_202 x_33267 x_33268 x_33269))
		(eps_17 x_33267 (Seq_16 r_243 q_71)))))
(assert (forall ((x_33270 Bool_202) (x_33271 Bool_202) (x_33272 Bool_202) (p_208 R_242) (q_72 R_242))
	(=>	(and (eps_17 x_33271 p_208)
			(eps_17 x_33272 q_72)
			(or_206 x_33270 x_33271 x_33272))
		(eps_17 x_33270 (Plus_67 p_208 q_72)))))
...
(assert (forall ((x_31239 R_242))
	(=> (eps_17 true_202 x_31239)
	    (epsR_8 Eps_16 x_31239))))
(assert (forall ((x_31239 R_242))
	(=> (eps_17 false_202 x_31239)
	    (epsR_8 Nil_157 x_31239))))
(declare-fun step_8 (R_242 R_242 A_34) Bool)
(assert (forall ((x_33280 R_242) (x_33281 R_242) (p_209 R_242) (y_1247 A_34))
	(=>	(and (step_8 x_33281 p_209 y_1247)
			(seq_17 x_33280 x_33281 (Star_8 p_209)))
		(step_8 x_33280 (Star_8 p_209) y_1247))))
(assert (forall ((x_33283 R_242) (x_33284 R_242) (x_33285 R_242) (x_33286 R_242) (x_33287 R_242) (x_33288 R_242) (r_244 R_242) (q_73 R_242) (y_1247 A_34))
	(=>	(and (step_8 x_33284 r_244 y_1247)
			(seq_17 x_33285 x_33284 q_73)
			(epsR_8 x_33286 r_244)
			(step_8 x_33287 q_73 y_1247)
			(seq_17 x_33288 x_33286 x_33287)
			(plus_68 x_33283 x_33285 x_33288))
		(step_8 x_33283 (Seq_16 r_244 q_73) y_1247))))
(assert (forall ((x_33290 R_242) (x_33291 R_242) (x_33292 R_242) (p_210 R_242) (q_74 R_242) (y_1247 A_34))
	(=>	(and (step_8 x_33291 p_210 y_1247)
			(step_8 x_33292 q_74 y_1247)
			(plus_68 x_33290 x_33291 x_33292))
		(step_8 x_33290 (Plus_67 p_210 q_74) y_1247))))
(assert (forall ((a_35 A_34) (y_1247 A_34))
	(=> (eqA_8 true_202 a_35 y_1247)
	    (step_8 Eps_16 (Atom_8 a_35) y_1247))))
(assert (forall ((a_35 A_34) (y_1247 A_34))
	(=> (eqA_8 false_202 a_35 y_1247)
	    (step_8 Nil_157 (Atom_8 a_35) y_1247))))
...
(assert (forall ((x_33300 Bool_202) (x_33301 R_242) (z_1162 A_34) (xs_379 list_141) (x_31242 R_242))
	(=>	(and (step_8 x_33301 x_31242 z_1162)
			(recognise_8 x_33300 x_33301 xs_379))
		(recognise_8 x_33300 x_31242 (cons_141 z_1162 xs_379)))))
(assert (forall ((x_33303 Bool_202) (x_31242 R_242))
	(=> (eps_17 x_33303 x_31242)
	    (recognise_8 x_33303 x_31242 nil_158))))
(assert (forall ((x_33305 Bool_202) (x_33306 Bool_202) (p_211 R_242) (q_75 R_242) (r_245 R_242) (s_295 list_141))
	(=>	(and true
			(diseqBool_89 x_33305 x_33306)
			(recognise_8 x_33305 (Seq_16 p_211 (Plus_67 q_75 r_245)) s_295)
			(recognise_8 x_33306 (Plus_67 (Seq_16 p_211 q_75) (Seq_16 p_211 r_245)) s_295))
		false)))
(check-sat)
