...
(assert (forall ((x_39797 A_41) (x_39798 A_41))
	(=> (diseqA_10 x_39797 x_39798)
	    (diseqR_10 (Atom_10 x_39797) (Atom_10 x_39798)))))
(assert (forall ((x_39799 R_276) (x_39800 R_276) (x_39801 R_276) (x_39802 R_276))
	(=> (diseqR_10 x_39799 x_39801)
	    (diseqR_10 (Plus_86 x_39799 x_39800) (Plus_86 x_39801 x_39802)))))
(assert (forall ((x_39799 R_276) (x_39800 R_276) (x_39801 R_276) (x_39802 R_276))
	(=> (diseqR_10 x_39800 x_39802)
	    (diseqR_10 (Plus_86 x_39799 x_39800) (Plus_86 x_39801 x_39802)))))
(assert (forall ((x_39803 R_276) (x_39804 R_276) (x_39805 R_276) (x_39806 R_276))
	(=> (diseqR_10 x_39803 x_39805)
	    (diseqR_10 (Seq_20 x_39803 x_39804) (Seq_20 x_39805 x_39806)))))
(assert (forall ((x_39803 R_276) (x_39804 R_276) (x_39805 R_276) (x_39806 R_276))
	(=> (diseqR_10 x_39804 x_39806)
	    (diseqR_10 (Seq_20 x_39803 x_39804) (Seq_20 x_39805 x_39806)))))
(assert (forall ((x_39807 R_276) (x_39808 R_276))
	(=> (diseqR_10 x_39807 x_39808)
	    (diseqR_10 (Star_10 x_39807) (Star_10 x_39808)))))
...
(assert (forall ((x_39819 A_41) (x_39820 list_154) (x_39821 A_41) (x_39822 list_154))
	(=> (diseqA_10 x_39819 x_39821)
	    (diseqlist_154 (cons_154 x_39819 x_39820) (cons_154 x_39821 x_39822)))))
(assert (forall ((x_39819 A_41) (x_39820 list_154) (x_39821 A_41) (x_39822 list_154))
	(=> (diseqlist_154 x_39820 x_39822)
	    (diseqlist_154 (cons_154 x_39819 x_39820) (cons_154 x_39821 x_39822)))))
...
(assert (forall ((x_39672 Bool_226) (x_39673 Bool_226) (x_39674 Bool_226) (r_277 R_276) (q_85 R_276))
	(=>	(and (eps_21 x_39673 r_277)
			(eps_21 x_39674 q_85)
			(and_226 x_39672 x_39673 x_39674))
		(eps_21 x_39672 (Seq_20 r_277 q_85)))))
(assert (forall ((x_39675 Bool_226) (x_39676 Bool_226) (x_39677 Bool_226) (p_251 R_276) (q_86 R_276))
	(=>	(and (eps_21 x_39676 p_251)
			(eps_21 x_39677 q_86)
			(or_230 x_39675 x_39676 x_39677))
		(eps_21 x_39675 (Plus_86 p_251 q_86)))))
...
(assert (forall ((x_37643 R_276))
	(=> (eps_21 true_226 x_37643)
	    (epsR_10 Eps_20 x_37643))))
(assert (forall ((x_37643 R_276))
	(=> (eps_21 false_226 x_37643)
	    (epsR_10 Nil_174 x_37643))))
(declare-fun step_10 (R_276 R_276 A_41) Bool)
(assert (forall ((x_39685 R_276) (x_39686 R_276) (p_252 R_276) (y_1458 A_41))
	(=>	(and (step_10 x_39686 p_252 y_1458)
			(seq_21 x_39685 x_39686 (Star_10 p_252)))
		(step_10 x_39685 (Star_10 p_252) y_1458))))
(assert (forall ((x_39688 R_276) (x_39689 R_276) (x_39690 R_276) (x_39691 R_276) (x_39692 R_276) (x_39693 R_276) (r_278 R_276) (q_87 R_276) (y_1458 A_41))
	(=>	(and (step_10 x_39689 r_278 y_1458)
			(seq_21 x_39690 x_39689 q_87)
			(epsR_10 x_39691 r_278)
			(step_10 x_39692 q_87 y_1458)
			(seq_21 x_39693 x_39691 x_39692)
			(plus_87 x_39688 x_39690 x_39693))
		(step_10 x_39688 (Seq_20 r_278 q_87) y_1458))))
(assert (forall ((x_39695 R_276) (x_39696 R_276) (x_39697 R_276) (p_253 R_276) (q_88 R_276) (y_1458 A_41))
	(=>	(and (step_10 x_39696 p_253 y_1458)
			(step_10 x_39697 q_88 y_1458)
			(plus_87 x_39695 x_39696 x_39697))
		(step_10 x_39695 (Plus_86 p_253 q_88) y_1458))))
(assert (forall ((a_42 A_41) (y_1458 A_41))
	(=> (eqA_10 true_226 a_42 y_1458)
	    (step_10 Eps_20 (Atom_10 a_42) y_1458))))
(assert (forall ((a_42 A_41) (y_1458 A_41))
	(=> (eqA_10 false_226 a_42 y_1458)
	    (step_10 Nil_174 (Atom_10 a_42) y_1458))))
...
(assert (forall ((x_39705 Bool_226) (x_39706 R_276) (z_1339 A_41) (xs_429 list_154) (x_37646 R_276))
	(=>	(and (step_10 x_39706 x_37646 z_1339)
			(recognise_10 x_39705 x_39706 xs_429))
		(recognise_10 x_39705 x_37646 (cons_154 z_1339 xs_429)))))
(assert (forall ((x_39708 Bool_226) (x_37646 R_276))
	(=> (eps_21 x_39708 x_37646)
	    (recognise_10 x_39708 x_37646 nil_175))))
(assert (forall ((x_37647 A_41) (y_1460 list_154))
	(=>	(and true
			(recognise_10 true_226 Eps_20 (cons_154 x_37647 y_1460)))
		false)))
(assert (=>	(and true
			(recognise_10 false_226 Eps_20 nil_175))
		false))
(check-sat)
