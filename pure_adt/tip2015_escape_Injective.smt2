...
(assert (forall ((x_34431 Token_1) (x_34432 list_147) (x_34433 Token_1) (x_34434 list_147))
	(=> (diseqToken_1 x_34431 x_34433)
	    (diseqlist_147 (cons_147 x_34431 x_34432) (cons_147 x_34433 x_34434)))))
(assert (forall ((x_34431 Token_1) (x_34432 list_147) (x_34433 Token_1) (x_34434 list_147))
	(=> (diseqlist_147 x_34432 x_34434)
	    (diseqlist_147 (cons_147 x_34431 x_34432) (cons_147 x_34433 x_34434)))))
...
(assert (forall ((x_34402 Token_1) (x_34403 list_147) (y_1350 Token_1) (xs_394 list_147))
	(=>	(and (code_1 x_34402 y_1350)
			(escape_1 x_34403 xs_394)
			(isSpecial_1 true_213 y_1350))
		(escape_1 (cons_147 ESC_1 (cons_147 x_34402 x_34403)) (cons_147 y_1350 xs_394)))))
(assert (forall ((x_34406 list_147) (y_1350 Token_1) (xs_394 list_147))
	(=>	(and (escape_1 x_34406 xs_394)
			(isSpecial_1 false_213 y_1350))
		(escape_1 (cons_147 y_1350 x_34406) (cons_147 y_1350 xs_394)))))
(assert (escape_1 nil_166 nil_166))
(assert (forall ((x_34408 list_147) (xs_395 list_147) (ys_127 list_147))
	(=>	(and true
			(diseqlist_147 xs_395 ys_127)
			(escape_1 x_34408 xs_395)
			(escape_1 x_34408 ys_127))
		false)))
(check-sat)
