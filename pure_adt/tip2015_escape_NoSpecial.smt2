...
(assert (forall ((x_26672 Token_0) (x_26673 list_125) (x_26674 Token_0) (x_26675 list_125))
	(=> (diseqToken_0 x_26672 x_26674)
	    (diseqlist_125 (cons_125 x_26672 x_26673) (cons_125 x_26674 x_26675)))))
(assert (forall ((x_26672 Token_0) (x_26673 list_125) (x_26674 Token_0) (x_26675 list_125))
	(=> (diseqlist_125 x_26673 x_26675)
	    (diseqlist_125 (cons_125 x_26672 x_26673) (cons_125 x_26674 x_26675)))))
...
(assert (forall ((x_26621 Bool_177) (x_26622 Bool_177) (x_26623 Bool_177) (y_1058 Token_0) (xs_335 list_125))
	(=>	(and (ok_0 x_26622 y_1058)
			(formula_1 x_26623 xs_335)
			(and_177 x_26621 x_26622 x_26623))
		(formula_1 x_26621 (cons_125 y_1058 xs_335)))))
...
(assert (forall ((x_26635 Token_0) (x_26636 list_125) (y_1059 Token_0) (xs_336 list_125))
	(=>	(and (code_0 x_26635 y_1059)
			(escape_0 x_26636 xs_336)
			(isSpecial_0 true_177 y_1059))
		(escape_0 (cons_125 ESC_0 (cons_125 x_26635 x_26636)) (cons_125 y_1059 xs_336)))))
(assert (forall ((x_26639 list_125) (y_1059 Token_0) (xs_336 list_125))
	(=>	(and (escape_0 x_26639 xs_336)
			(isSpecial_0 false_177 y_1059))
		(escape_0 (cons_125 y_1059 x_26639) (cons_125 y_1059 xs_336)))))
(assert (escape_0 nil_139 nil_139))
(assert (forall ((x_26641 list_125) (xs_337 list_125))
	(=>	(and true
			(escape_0 x_26641 xs_337)
			(formula_1 false_177 x_26641))
		false)))
(check-sat)
