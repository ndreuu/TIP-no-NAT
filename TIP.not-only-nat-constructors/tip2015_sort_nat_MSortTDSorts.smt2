...
(assert (forall ((x Int) (y Int))
	(=> (distinct x y) (lt_222 false_209 x y))))
(assert (forall ((x Int) (y Int))
	(=> (= x y) (lt_222 true_209 x y))))
(assert (forall ((x_33973 Int))
	(lt_222 false_209 x_33973 zero_81)))
(declare-fun leq_31 (Bool_209 Int Int) Bool)
(assert (forall ((x Int) (y Int))
	(=> (distinct x y) (leq_31 false_209 x y))))
(assert (forall ((x Int) (y Int))
	(=> (= x y) (leq_31 true_209 x y))))
...
(assert (forall ((x_34047 Int) (x_34048 Int) (x_34049 Int) (x_34050 Int) (x_33987 Int) (y_1326 Int) (z_1229 Int))
	(=> (and true (distinct x_34048 x_34050) (plus_72 x_34047 y_1326 z_1229) (plus_72 x_34048 x_33987 x_34047) (plus_72 x_34049 x_33987 y_1326) (plus_72 x_34050 x_34049 z_1229)) false)))
(assert (forall ((x_34051 Int) (x_34052 Int) (x_33988 Int) (y_1327 Int))
	(=> (and true (distinct x_34051 x_34052) (plus_72 x_34051 x_33988 y_1327) (plus_72 x_34052 y_1327 x_33988)) false)))
(assert (forall ((x_34053 Int) (x_33989 Int))
	(=> (and true (distinct x_34053 x_33989) (plus_72 x_34053 x_33989 zero_81)) false)))
(assert (forall ((x_34054 Int) (x_33990 Int))
	(=> (and true (distinct x_34054 x_33990) (plus_72 x_34054 zero_81 x_33990)) false)))
