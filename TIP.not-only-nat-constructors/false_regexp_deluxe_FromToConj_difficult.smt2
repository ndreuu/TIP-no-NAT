...
(assert (forall ((x_96895 Int) (x_96896 Int) (x_96665 R_566) (x_92448 R_566) (z_2508 Int))
	(=> (and (distinct z_2508 Z_2510) (rep_1 x_96665 x_92448 x_96895 x_96896) (minus_434 x_96895 Z_2510 (S_583 Z_2510)) (minus_434 x_96896 z_2508 (S_583 Z_2510))) (rep_1 (x_92437 (x_92435 Eps_70 x_92448) x_96665) x_92448 Z_2510 z_2508))))
(assert (forall ((x_92448 R_566))
	(rep_1 Eps_70 x_92448 Z_2510 Z_2510)))
(assert (forall ((x_96897 Int) (x_96898 Int) (x_96668 R_566) (x_92448 R_566) (y_2860 Int) (z_2508 Int))
	(=> (and (distinct z_2508 Z_2510) (distinct y_2860 Z_2510) (rep_1 x_96668 x_92448 x_96897 x_96898) (minus_434 x_96897 y_2860 (S_583 Z_2510)) (minus_434 x_96898 z_2508 (S_583 Z_2510))) (rep_1 (x_92437 (x_92435 Nil_395 x_92448) x_96668) x_92448 y_2860 z_2508))))
(assert (forall ((x_92448 R_566) (y_2860 Int))
	(=> (distinct y_2860 Z_2510) (rep_1 Nil_395 x_92448 y_2860 Z_2510))))
(assert (forall ((x_96899 Int) (x_96900 Int) (x_96671 R_566) (x_92448 R_566) (z_2508 Int))
	(=> (and (distinct z_2508 Z_2510) (rep_1 x_96671 x_92448 x_96899 x_96900) (minus_434 x_96899 Z_2510 (S_583 Z_2510)) (minus_434 x_96900 z_2508 (S_583 Z_2510))) (rep_1 (x_92437 (x_92435 Eps_70 x_92448) x_96671) x_92448 Z_2510 z_2508))))
(assert (forall ((x_92448 R_566) (y_2860 Int))
	(=> (distinct y_2860 Z_2510) (rep_1 Nil_395 x_92448 y_2860 Z_2510))))
(assert (forall ((x_96901 Int) (x_96902 Int) (x_96674 R_566) (x_92448 R_566) (y_2860 Int) (z_2508 Int))
	(=> (and (distinct z_2508 Z_2510) (distinct y_2860 Z_2510) (rep_1 x_96674 x_92448 x_96901 x_96902) (minus_434 x_96901 y_2860 (S_583 Z_2510)) (minus_434 x_96902 z_2508 (S_583 Z_2510))) (rep_1 (x_92437 (x_92435 Nil_395 x_92448) x_96674) x_92448 y_2860 z_2508))))
