...
(assert (forall ((x Int) (y Int))
	(=> (distinct x y) (leq_18 false_166 x y))))
(assert (forall ((x Int) (y Int))
	(=> (= x y) (leq_18 true_166 x y))))
...
(assert (forall ((x_25633 Int) (x_25634 Int) (x_25635 Int) (x_25636 Int) (x_25558 Int) (y_972 Int) (z_946 Int))
	(=> (and true (distinct x_25634 x_25636) (plus_51 x_25633 y_972 z_946) (plus_51 x_25634 x_25558 x_25633) (plus_51 x_25635 x_25558 y_972) (plus_51 x_25636 x_25635 z_946)) false)))
(assert (forall ((x_25637 Int) (x_25638 Int) (x_25559 Int) (y_973 Int))
	(=> (and true (distinct x_25637 x_25638) (plus_51 x_25637 x_25559 y_973) (plus_51 x_25638 y_973 x_25559)) false)))
(assert (forall ((x_25639 Int) (x_25560 Int))
	(=> (and true (distinct x_25639 x_25560) (plus_51 x_25639 x_25560 zero_52)) false)))
(assert (forall ((x_25640 Int) (x_25561 Int))
	(=> (and true (distinct x_25640 x_25561) (plus_51 x_25640 zero_52 x_25561)) false)))
(assert (forall ((x_25641 list_119) (x_25642 Int) (x_25643 Int) (x_25562 Int) (xs_308 list_119))
	(=> (and true (distinct x_25642 x_25643) (bsort_4 x_25641 xs_308) (count_19 x_25642 x_25562 x_25641) (count_19 x_25643 x_25562 xs_308)) false)))
(check-sat)
