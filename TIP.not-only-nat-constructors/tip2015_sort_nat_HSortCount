...
(assert (forall ((x Int) (y Int))
	(=> (distinct x y) (leq_17 false_155 x y))))
(assert (forall ((x Int) (y Int))
	(=> (= x y) (leq_17 true_155 x y))))
...
(assert (forall ((x_22622 Int) (x_22623 Int) (x_22624 Int) (x_22625 Int) (x_22573 Int) (y_888 Int) (z_880 Int))
	(=> (and true (distinct x_22623 x_22625) (plus_45 x_22622 y_888 z_880) (plus_45 x_22623 x_22573 x_22622) (plus_45 x_22624 x_22573 y_888) (plus_45 x_22625 x_22624 z_880)) false)))
(assert (forall ((x_22626 Int) (x_22627 Int) (x_22574 Int) (y_889 Int))
	(=> (and true (distinct x_22626 x_22627) (plus_45 x_22626 x_22574 y_889) (plus_45 x_22627 y_889 x_22574)) false)))
(assert (forall ((x_22628 Int) (x_22575 Int))
	(=> (and true (distinct x_22628 x_22575) (plus_45 x_22628 x_22575 zero_47)) false)))
(assert (forall ((x_22629 Int) (x_22576 Int))
	(=> (and true (distinct x_22629 x_22576) (plus_45 x_22629 zero_47 x_22576)) false)))
(assert (forall ((x_22630 list_110) (x_22631 Int) (x_22632 Int) (x_22577 Int) (xs_273 list_110))
	(=> (and true (distinct x_22631 x_22632) (hsort_3 x_22630 xs_273) (count_18 x_22631 x_22577 x_22630) (count_18 x_22632 x_22577 xs_273)) false)))
(check-sat)
