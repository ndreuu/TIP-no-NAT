...
(assert (forall ((x Int) (y Int))
	(=> (distinct x y) (lt_111 false_109 x y))))
(assert (forall ((x Int) (y Int))
	(=> (= x y) (lt_111 true_109 x y))))
(assert (forall ((x_12481 Int))
	(lt_111 false_109 x_12481 zero_20)))
(declare-fun leq_8 (Bool_109 Int Int) Bool)
(assert (forall ((x Int) (y Int))
	(=> (distinct x y) (leq_8 false_109 x y))))
(assert (forall ((x Int) (y Int))
	(=> (= x y) (leq_8 true_109 x y))))
...
(assert (forall ((x_12561 Int) (x_12562 Int) (x_12563 Int) (x_12564 Int) (x_12496 Int) (y_552 Int) (z_603 Int))
	(=> (and true (distinct x_12562 x_12564) (plus_16 x_12561 y_552 z_603) (plus_16 x_12562 x_12496 x_12561) (plus_16 x_12563 x_12496 y_552) (plus_16 x_12564 x_12563 z_603)) false)))
(assert (forall ((x_12565 Int) (x_12566 Int) (x_12497 Int) (y_553 Int))
	(=> (and true (distinct x_12565 x_12566) (plus_16 x_12565 x_12497 y_553) (plus_16 x_12566 y_553 x_12497)) false)))
(assert (forall ((x_12567 Int) (x_12498 Int))
	(=> (and true (distinct x_12567 x_12498) (plus_16 x_12567 x_12498 zero_20)) false)))
(assert (forall ((x_12568 Int) (x_12499 Int))
	(=> (and true (distinct x_12568 x_12499) (plus_16 x_12568 zero_20 x_12499)) false)))
