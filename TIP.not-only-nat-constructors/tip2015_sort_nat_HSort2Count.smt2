...
(assert (forall ((x Int) (y Int))
	(=> (distinct x y) (leq_0 false_79 x y))))
(assert (forall ((x Int) (y Int))
	(=> (= x y) (leq_0 true_79 x y))))
...
(assert (forall ((x_4159 Int) (x_4160 Int) (x_4161 Int) (x_4162 Int) (x_4120 Int) (y_344 Int) (z_431 Int))
	(=> (and true (distinct x_4160 x_4162) (plus_0 x_4159 y_344 z_431) (plus_0 x_4160 x_4120 x_4159) (plus_0 x_4161 x_4120 y_344) (plus_0 x_4162 x_4161 z_431)) false)))
(assert (forall ((x_4163 Int) (x_4164 Int) (x_4121 Int) (y_345 Int))
	(=> (and true (distinct x_4163 x_4164) (plus_0 x_4163 x_4121 y_345) (plus_0 x_4164 y_345 x_4121)) false)))
(assert (forall ((x_4165 Int) (x_4122 Int))
	(=> (and true (distinct x_4165 x_4122) (plus_0 x_4165 x_4122 zero_1)) false)))
(assert (forall ((x_4166 Int) (x_4123 Int))
	(=> (and true (distinct x_4166 x_4123) (plus_0 x_4166 zero_1 x_4123)) false)))
(assert (forall ((x_4167 list_66) (x_4168 Int) (x_4169 Int) (x_4124 Int) (xs_124 list_66))
	(=> (and true (distinct x_4168 x_4169) (hsort_0 x_4167 xs_124) (count_10 x_4168 x_4124 x_4167) (count_10 x_4169 x_4124 xs_124)) false)))
(check-sat)
