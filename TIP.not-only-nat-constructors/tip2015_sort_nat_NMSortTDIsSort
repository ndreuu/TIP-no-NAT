...
(assert (forall ((x Int) (y Int))
	(=> (distinct x y) (leq_35 false_238 x y))))
(assert (forall ((x Int) (y Int))
	(=> (= x y) (leq_35 true_238 x y))))
...
(assert (forall ((x_45317 Int) (x_45318 Int) (x_45319 Int) (x_45320 Int) (x_45255 Int) (y_1578 Int) (z_1426 Int))
	(=> (and true (distinct x_45318 x_45320) (plus_95 x_45317 y_1578 z_1426) (plus_95 x_45318 x_45255 x_45317) (plus_95 x_45319 x_45255 y_1578) (plus_95 x_45320 x_45319 z_1426)) false)))
(assert (forall ((x_45321 Int) (x_45322 Int) (x_45256 Int) (y_1579 Int))
	(=> (and true (distinct x_45321 x_45322) (plus_95 x_45321 x_45256 y_1579) (plus_95 x_45322 y_1579 x_45256)) false)))
(assert (forall ((x_45323 Int) (x_45257 Int))
	(=> (and true (distinct x_45323 x_45257) (plus_95 x_45323 x_45257 zero_95)) false)))
(assert (forall ((x_45324 Int) (x_45258 Int))
	(=> (and true (distinct x_45324 x_45258) (plus_95 x_45324 zero_95 x_45258)) false)))
